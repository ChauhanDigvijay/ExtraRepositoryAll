...
//Event Management
@property (nonatomic, readwrite)BOOL isTriggerAppEvent,isTriggerGeoFence,isTriggerBeacon,isTriggerErrorEvent,isPushNotification,isInAPPOffer,isForceUpdate;
@property (nonatomic, assign) NSInteger intDelayTimer,intMaxEvents,intFrequency,intTokenCounter;
@property (nonatomic,strong) NSString *appVersion,*appInformation;
