...
public class SpendGoSessionService {
    ...
    /// Create a new member
    public class func addMember(user: SpendGoUser, password: String, favoriteStoreCode: String, sendWelcomeEmail: Bool = true, emailValidated: Bool = false, callback: SpendGoErrorAnd202Callback) {
        ...
        JSONDict["favorite_store_code"]  = favoriteStoreCode
