...
class ChangePasswordViewController: UIViewController {
    ...
    private func changePassword() {
        ...
        SVProgressHUD.showWithStatus("Updating password...", maskType: .Clear)
    ...
    @IBAction func textFieldEditingChanged(sender: AnyObject) {
        ...
        passwordValidationImageView.hidden = newPasswordTextField.text == nil || newPasswordTextField.text!.isEmpty || newPasswordTextField.text != confirmPasswordTextField.text
    }
