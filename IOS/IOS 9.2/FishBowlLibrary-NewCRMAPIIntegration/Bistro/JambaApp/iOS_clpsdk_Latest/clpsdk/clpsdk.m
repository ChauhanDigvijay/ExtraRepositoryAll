...
// client ID for QA      201969E1BFD242E189FE7B6297B1B5A6
// client ID for General 201969E1BFD242E189FE7B6297B1B5A5

# define Client_ID @"201969E1BFD242E189FE7B6297B1B5A6"
...
@synthesize delegate,authToken,intTokenCounter,client_ID;
static clpsdk* __strong instance = nil;



+(clpsdk *)sharedInstanceWithAPIKey:(NSString*)mobileAPIKey withBaseURL:(NSString*)serverURL withClientID:(NSString *)clientID
{
    if(instance){
        return instance;
    }else{
        ...
        instance.SERVER_URL = serverURL;
        instance.client_ID  =  clientID;
        instance.intTokenCounter = 0;
        ...
        NSLog(@"instance client_ID--------- %@",instance.client_ID);
        ...
        [instance getMobilePreference];
         ...
         NSString * authToken = [[NSUserDefaults standardUserDefaults]valueForKey:@"access_token"];
        
        if(authToken.length == 0)
        {
           [instance accessTokenApi];
        }
        else
        {
           [instance getMobilePreference];
...
-(void)getMobilePreference{
    ...
    [manager.requestSerializer setValue:@"C65A0DC0F28C469FB7376F972DEFBCB8" forHTTPHeaderField:@"client_secret"];
    [manager.requestSerializer setValue:[UIDevice currentDevice].identifierForVendor.UUIDString forHTTPHeaderField:@"deviceId"];

    
    NSLog(@" Hit getMobilePreference");
      ...
      parameters:nil
         success:^(AFHTTPRequestOperation *operation, id responseObject) {
             ...
             if ([responseObject isKindOfClass:[NSDictionary class]]) {
                 if([[[(NSDictionary*)responseObject valueForKey:@"mobSettingList"] valueForKey:@"mobileSettings"] isKindOfClass:[NSArray class] ]){
                     ...
                     if ([self getObjectForMobileSettingsName:@"INAPPOFFER_ENABLED"]!=nil) {
                         ...
                         [[NSUserDefaults standardUserDefaults] setBool:isInAPPOffer forKey:@"isInAPPOffer"];
                 ...
                 if([[[(NSDictionary*)responseObject valueForKey:@"digitalEventList"] valueForKey:@"digitalEventList"] isKindOfClass:[NSArray class] ]){
                     ...
                     if(isOpen == NO)
                     {
                         ...
                         [dict setValue:@"Opened" forKey:@"event_name"];
             ...
             if (operation.response.statusCode == 401)
             {
                 ...
                 [self getToken:^(BOOL success, NSError *error) {
                     
                     if (error == nil) {
                         
                         intTokenCounter = 0;
                         [self getMobilePreference];
                         
                     }
                     
                     else
                     {
                         intTokenCounter = intTokenCounter+1;
                         if(intTokenCounter<=1)
                         {
                             [self getRefrshedToken];
                             [self getMobilePreference];
...
-(void)getToken:(void (^)(BOOL success, NSError *error))response
{
    AFHTTPRequestOperationManager *manager=[AFHTTPRequestOperationManager manager];
    manager.requestSerializer = [AFJSONRequestSerializer serializer];
    [manager.requestSerializer setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
    ...
    [manager.requestSerializer setValue:client_ID forHTTPHeaderField:@"client_id"];
    [manager.requestSerializer setValue:@"C65A0DC0F28C469FB7376F972DEFBCB7" forHTTPHeaderField:@"client_secret"];
    [manager.requestSerializer setValue:@"token" forHTTPHeaderField:@"response_type"];
    [manager.requestSerializer setValue:@"read" forHTTPHeaderField:@"scope"];
    [manager.requestSerializer setValue:@"stateless" forHTTPHeaderField:@"state"];
    [manager.requestSerializer setValue:[UIDevice currentDevice].identifierForVendor.UUIDString forHTTPHeaderField:@"deviceId"];
    ...
    [manager POST:[SERVER_URL stringByAppendingString:@"clpapi/member/login"] parameters:dict success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"SUCCESS JSON: response %@", responseObject);
        
        NSLog(@"SUCCESS JSON GetToken API: response %@", responseObject);
        ...
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
            ...
            [[NSUserDefaults standardUserDefaults]setValue:[responseObject valueForKey:@"accessToken"] forKey:@"access_token"];
            
//            [self getALLStoreList];
//            [self getMobilePreference];
            response(true,nil);
            authToken = [[NSUserDefaults standardUserDefaults]valueForKey:@"access_token"];
            NSLog(@"app access token api device id-------%@ %@",customerresponse,authToken);
            
        }
        else
        {
            response(false,nil);
             NSLog(@"Token not found %@",responseObject);
             ...
             success:^(AFHTTPRequestOperation *operation, id responseObject) {
                 ...
                 if ([responseObject isKindOfClass:[NSDictionary class]]) {
                     ...
                     if ([[storeresponse valueForKey:@"stores"] isKindOfClass:[NSArray class]]){
                         ...
                         NSLog(@"Store list is %lu",(unsigned long)storeList.count);
      ...
      parameters:nil
         success:^(AFHTTPRequestOperation *operation, id responseObject) {
             ...
             if ([responseObject isKindOfClass:[NSDictionary class]]) {
                 ...
                 NSLog(@"responseObject is %@",storeresponse.description);
                 ...
                 if ([[storeresponse valueForKey:@"stores"] isKindOfClass:[NSArray class]]){
                     ...
                     NSLog(@"responseObject is %lu",(unsigned long)storeList.count);

                     //response(true,nil);
                 }else{
                     //response(false,nil);
                     NSLog(@"store key not found %@",storeresponse);
                     NSLog(@"After store 12");

                 }
             }else{
                 //response(false,nil);
                 NSLog(@"Dictionary not found %@",responseObject);
                 NSLog(@"After store 14");

             }
         }failure:^(AFHTTPRequestOperation *operation, NSError *error) {
             NSLog(@"Error: %@", error);
             NSLog(@"After store 15");
...
- (void)createCustomer:(FBGuest *)customerInfo :(void (^)(FBGuest *cusInfo, NSError *error))response
    {
        ...
        [manager POST:[SERVER_URL stringByAppendingString:@"clpapi/mobile/appcustomer"] parameters:dict success:^(AFHTTPRequestOperation *operation, id responseObject) {
            ...
            if ([responseObject isKindOfClass:[NSDictionary class]]) {
                ...
                // Call LoginApi With Acces Token
            ...
            if (operation.response.statusCode == 401)
            {
                ...
                [self getToken:^(BOOL success, NSError *error) {
                    ...
                    if (error == nil) {
                        ...
                        [self createCustomer:customerInfo :^(FBGuest *cusInfo, NSError *error)
                        {
                            if (error == nil)
                            {
                                NSLog(@"customer create successful");
                            }
                        }];
...
-(void)accessTokenApi
{
    ...
    [manager POST:[SERVER_URL stringByAppendingString:@"clpapi/member/login"] parameters:dict success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        NSLog(@"SUCCESS JSON Access Token API: response %@", responseObject);
     ...
     [[NSUserDefaults standardUserDefaults]synchronize];
        ...
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
          ...
          [[NSUserDefaults standardUserDefaults]setValue:[responseObject valueForKey:@"accessToken"] forKey:@"access_token"];
            ...
            NSString * s = [[NSUserDefaults standardUserDefaults]valueForKey:@"access_token"];
            NSLog(@"app access token api device id-------%@ %@",customerresponse,s);
   ...
   NSLog(@"CLPCustomer Save Customer");
    ...
    [manager POST:[SERVER_URL stringByAppendingString:@"clpapi/mobile/appcustomer"] parameters:[customerInfo toDictionary] success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
            ...
            currentCustomer.email=[customerresponse valueForKey:@"email"];
            ...
            currentCustomer.phone=[customerresponse valueForKey:@"cellPhone"];
            ...
            currentCustomer.birthDate=[customerresponse valueForKey:@"dateOfBirth"];
            currentCustomer.customerAge=[customerresponse valueForKey:@"customerAge"];
            currentCustomer.storeCode=[customerresponse valueForKey:@"homeStore"];
            currentCustomer.homeStoreID=[customerresponse valueForKey:@"homeStoreID"];
            currentCustomer.favoriteStore=[customerresponse valueForKey:@"favoriteDepartment"];
        ...
        if (operation.response.statusCode == 401)
        {
            ...
            [self getToken:^(BOOL success, NSError *error) {
                ...
                if (error == nil) {
                    ...
                    [self saveCustomer:customerInfo :^(CLPCustomer *cusInfo, NSError *error) {
        ...
        if (operation.response.statusCode == 401)
        {
            ...
            [self getToken:^(BOOL success, NSError *error) {
                ...
                if (error == nil) {
                    ...
                    [self CustomerCreation:customerInfo :^(CLPCustomer *cusInfo, NSError *error) {
                        
                        if (error == nil)
                        {
                            NSLog(@"CustomerCreation");
                        }
                    }];
...
// update device code for fishbowl sdk
...
//    {
        ...
        storeCode = currentCustomer.storeCode;
        NSLog(@"store code-------%@",storeCode);
        [dict1 setValue:storeCode forKey:@"storecode"];
    //}
    
     NSLog(@"storeCode customer-----------------%@",storeCode);
...
//        }
        if(alert){
            ...
            if(([ntype caseInsensitiveCompare:@"pass"]!=NSOrderedSame))
            {
                ...
                [delegate clpPushDataBinding:promoCode withId:offerid];
            }
        }
...
-(void)updateAppEvent:(NSDictionary *)submitAppEvents{
    ...
    @try {
       ...
       // NSLog(@"GuestCustomer is %@",GuestCustomer.description);
        ...
        {
            NSLog(@"GuestCustomerEvents");
            NSLog(@"%@",GuestCustomer.description);
...
//    BOOL isTheObjectThere = [arrEventNewSetting containsObject: [mydict valueForKey:@"event_name"]];
        
//        NSLog(@"isTheObjectThere is %i",isTheObjectThere);
...
-(void)appEventTimerMethodCall
{
    ...
    if(arrEventRequest.count>0)
    {
        ...
        [manager POST:[SERVER_URL stringByAppendingString:@"clpapi/event/submitallappevents"] parameters:dictPost success:^(AFHTTPRequestOperation *operation, id responseObject) {
            NSLog(@"SUCCESS JSON: response clpapi/event/submitallappevents %@", responseObject);
        ...
        if (operation.response.statusCode == 401)
        {
            ...
            [self getToken:^(BOOL success, NSError *error) {
                ...
                if (error == nil) {
                    ...
                    [self updateOfferEvent:submitClpEvents];
                }
            ...
            if (operation.response.statusCode == 401)
            {
                ...
                [self getToken:^(BOOL success, NSError *error) {
                    ...
                    if (error == nil) {
                        ...
                        [self updateOfferEventWithPass:submitClpEvents];
                    }
             ...
             if (operation.response.statusCode == 401)
             {
                 ...
                 [self getToken:^(BOOL success, NSError *error) {
                     ...
                     if (error == nil) {
                         ...
                         [self StartBeaconRegionMonitoring:storeId];
                     }
             ...
             if (operation.response.statusCode == 401)
             {
                 ...
                 [self getToken:^(BOOL success, NSError *error) {
                     ...
                     if (error == nil) {
                         ...
                         [self HandleBeaconEnterRegion:region];
                     }
...
-(void)locationManager:(CLLocationManager *)manager didRangeBeacons:(NSArray *)beacons
    ...
    if(lastbeacon_updatetime && abs([lastbeacon_updatetime timeIntervalSinceNow])<BEACON_PING_FREQUENCY){
    ...
    httpReqopmgr.requestSerializer = [AFJSONRequestSerializer serializer];
        NSString * accessToken = [[NSUserDefaults standardUserDefaults]valueForKey:@"access_token"];
        [httpReqopmgr.requestSerializer setValue:accessToken forHTTPHeaderField:@"access_token"];
        ...
        [httpReqopmgr.requestSerializer setValue:@"fishbowl" forHTTPHeaderField:@"tenantName"];
        [httpReqopmgr.requestSerializer setValue:client_ID forHTTPHeaderField:@"client_id"];
        [httpReqopmgr.requestSerializer setValue:@"C65A0DC0F28C469FB7376F972DEFBCB8" forHTTPHeaderField:@"client_secret"];
        [httpReqopmgr.requestSerializer setValue:[UIDevice currentDevice].identifierForVendor.UUIDString forHTTPHeaderField:@"deviceId"];
    ...
    if (storeList.count == 0)
    {
        ...
        isStoreListPopulated=true;
            ...
            if(storeList!=nil && storeList.count!=0){
                ...
                [self.delegate storeListResponseSucceed];
            }
            else
            {
