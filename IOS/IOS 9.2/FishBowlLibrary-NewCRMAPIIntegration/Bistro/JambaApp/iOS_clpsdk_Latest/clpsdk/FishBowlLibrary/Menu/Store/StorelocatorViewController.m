...
- (void)viewDidLoad {
    ...
    //self.sea.backgroundColor= [obj colorWithHexString:[dict valueForKey:@"checkInButtonColor"]];
    
    self.segmentButton.tintColor = [obj colorWithHexString:[dict valueForKey:@"checkInButtonColor"]];
...
-(IBAction)myMethod:(id)sender
{
    ...
    orderCompObj.strSelectCity=strCity1;
    orderCompObj.strSelectAddress=strAddress;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    orderCompObj.strSelectCity=[[storesDict valueForKey:@"city"]objectAtIndex:indexPath.row];
    orderCompObj.strSelectAddress=[[storesDict valueForKey:@"address"]objectAtIndex:indexPath.row];;
    [self.navigationController pushViewController:orderCompObj animated:YES];
