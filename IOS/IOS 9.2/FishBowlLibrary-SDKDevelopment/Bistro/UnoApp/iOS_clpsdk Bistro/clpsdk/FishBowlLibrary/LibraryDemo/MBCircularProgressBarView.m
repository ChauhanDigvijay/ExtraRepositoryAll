...
-(void)initView:(CGRect)frame{
    ...
    [self setValue:0.f];
    [self setMaxValue:35.f];
    [self setProgressRotationAngle:0.f];
    [self setProgressStrokeColor:[UIColor clearColor]];
    ...
    [self setValueFontName:@"Proxima Nova"];
    [self setTextOffset:CGPointMake(0, 0)];
    [self setUnitFontName:@"Proxima Nova"];
...
-(void)setUnitString:(NSString *)unitString{
    ...
    self.progressLayer.unitString = unitString;
        NSLog(@"unit1-----%@",self.progressLayer.unitString);
    }
    else
    {
         NSLog(@"unit2-----%@",self.progressLayer.unitString);
    self.progressLayer.unitString = @"";
    }
}

-(NSString*)unitString{
    if(self.progressLayer.unitString!=0)
    {
         NSLog(@"unit3-----%@",self.progressLayer.unitString);
        return self.progressLayer.unitString;
    }
  else
    {
         NSLog(@"unit4-----%@",self.progressLayer.unitString);
      return 0 ;
