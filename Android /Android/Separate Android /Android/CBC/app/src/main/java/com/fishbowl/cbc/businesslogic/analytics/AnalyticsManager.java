...
public class AnalyticsManager {
    ...
    public AnalyticsManager(CbcApplication context) {
        analytics = GoogleAnalytics.getInstance(context);
        /**
         * TODO: google_analytics tracking id
         */
        tracker = analytics.newTracker(context.getString(Integer.parseInt("")));
    ...
    public static AnalyticsManager getInstance() {
        if (instance == null) {
            instance = new AnalyticsManager(CbcApplication.getInstance());
        }
        return instance;
    }
    ...
    public void trackEvent(String category, String action, String label, long value, String screenName) {
        ...
        AppsFlyerLib.trackEvent(CbcApplication.getInstance(), action, eventValues);
    }
    ...
    public void trackPurchase(OrderStatus orderStatus, List<BasketProduct> basketProducts) {
        ...
        for (BasketProduct basketProduct : basketProducts) {
            ...
            AppsFlyerLib.trackEvent(CbcApplication.getInstance(), "af_purchase", eventValues);
        }
    }
    ...
    public void trackUserLogin() {
        ...
        HashMap<String, Object> eventValues = new HashMap<>();
        AppsFlyerLib.trackEvent(CbcApplication.getInstance(), "af_login", eventValues);
    }
    ...
    public void trackUserRegistration() {
        ...
        HashMap<String, Object> eventValues = new HashMap<>();
        AppsFlyerLib.trackEvent(CbcApplication.getInstance(), "af_complete_registration", eventValues);
    }
