...
public class GPSTracker extends Service implements LocationListener {
    ...
    public boolean hasAltitude() {
        if (this.location != null) {
            this.hasAltitude = Boolean.valueOf(this.location.hasAltitude());
        }
        return this.hasAltitude.booleanValue();
    }
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setPositiveButton("Settings", new C08151());
        alertDialog.setNegativeButton("Cancel", new C08162());
        alertDialog.show();
    }
