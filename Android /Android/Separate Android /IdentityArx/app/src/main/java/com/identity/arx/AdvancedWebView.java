...
public class AdvancedWebView extends WebView {
    ...
    protected String mUploadableFileTypes = MediaType.ALL_VALUE;

    class C07221 extends WebViewClient {
        C07221() {
        }
    ...
    class C07232 extends WebChromeClient {
        C07232() {
        }
    ...
    class C07243 implements DownloadListener {
        C07243() {
        }
    ...
    public void loadHtml(String html, String baseUrl, String historyUrl, String encoding) {
        loadDataWithBaseURL(baseUrl, html, MediaType.TEXT_HTML_VALUE, encoding, historyUrl);
    }
    ...
    protected void init(Context context) {
        if (!isInEditMode()) {
            ...
            super.setWebViewClient(new C07221());
            super.setWebChromeClient(new C07232());
            setDownloadListener(new C07243());
        }
    }
