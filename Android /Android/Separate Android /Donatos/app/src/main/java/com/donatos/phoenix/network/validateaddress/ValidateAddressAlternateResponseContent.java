...
@JsonObject
public class ValidateAddressAlternateResponseContent {
    ...
    public ValidateAddressAlternateResponseContent address(ValidateAddressAddress validateAddressAddress) {
    ...
    public boolean equals(Object obj) {
        ...
        return C2507k.m7346a(this.address, ((ValidateAddressAlternateResponseContent) obj).address);
    }
    ...
    public String toString() {
        ...
        stringBuilder.append("class ValidateAddressAlternateResponseContent {\n");
