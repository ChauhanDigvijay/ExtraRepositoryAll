...
public class LoyaltyCardModel {
    ...
    public String dividerThickness;

    public String frontHeaderFontAlignment;


    public String frontBodyText1TxtAlign;
    public String  frontBodyText2TxtAlign;

    public String frontBodyText3TxtAlign;
    public String  frontBodyText4TxtAlign;
    public LoyaltyCardModel(JSONObject obj) {
        ...
        try {
            ...
            dividerColor= obj.has("dividerColor") ? obj.getString("dividerColor") : null;
            dividerThickness= obj.has("dividerThickness") ? obj.getString("dividerThickness") : null;
            frontHeaderFontAlignment= obj.has("frontHeaderFontAlignment") ? obj.getString("frontHeaderFontAlignment") : null;
            frontBodyText1TxtAlign= obj.has("frontBodyText1TxtAlign") ? obj.getString("frontBodyText1TxtAlign") : null;
            frontBodyText2TxtAlign=obj.has("frontBodyText2TxtAlign") ? obj.getString("frontBodyText2TxtAlign") : null;
            frontBodyText3TxtAlign=obj.has("frontBodyText3TxtAlign") ? obj.getString("frontBodyText3TxtAlign") : null;
            frontBodyText4TxtAlign=obj.has("frontBodyText4TxtAlign") ? obj.getString("frontBodyText4TxtAlign") : null;
        } catch (Exception e) {
            e.printStackTrace();
