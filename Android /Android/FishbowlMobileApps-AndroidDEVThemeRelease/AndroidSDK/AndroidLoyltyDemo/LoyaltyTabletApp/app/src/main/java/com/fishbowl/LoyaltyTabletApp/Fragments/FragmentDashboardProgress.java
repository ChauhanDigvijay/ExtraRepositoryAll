...
import com.fishbowl.LoyaltyTabletApp.Activites.NonGeneric.Settings.ProgramDeetailActivity;
...
public class FragmentDashboardProgress extends Fragment implements View.OnClickListener {
    ...
    public void onStart() {
        ...
        final String url1 = "http://" + FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralLogoImageUrl");
        ...
        if (buttoncolor != null) {
            ...
            btn1.setBackgroundColor(Color.parseColor(buttoncolor));
            button2.setBackgroundColor(Color.parseColor(buttoncolor));
            mSeekArc.setProgressColor(Color.parseColor(buttoncolor));
            loyatycardlayout.setBackgroundColor(Color.parseColor(buttoncolor));
        ...
        if (buttoncolor != null) {
            ...
            btn1.setBackgroundColor(Color.parseColor( FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonBGColorNormal")));
            txt_program_detail.setTextColor(Color.parseColor( FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonStateFontColor")));
            ...
            button2.setBackgroundColor(Color.parseColor(FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonBGColorNormal")));
            button2.setBackgroundResource(R.drawable.normal);
            GradientDrawable gd1 = (GradientDrawable) button2.getBackground().getCurrent();
            gd.setColor(Color.parseColor(  FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonBGColorNormal")));
            gd.setCornerRadii(new float[]{10, 10, 10, 10, 10, 10, 10, 10});
            gd.setStroke(1, Color.parseColor("#444444"), 0, 0);
            gd1.setColor(Color.parseColor( FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonBGColorNormal")));
