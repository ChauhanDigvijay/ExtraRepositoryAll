...
public class FragmentSignup extends Fragment {
    ...
    public void onStart() {
        ...
        if (buttoncolor != null) {
            ...
            registration_button.setBackgroundColor(Color.parseColor("#" + FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonType1NormalColor")));
