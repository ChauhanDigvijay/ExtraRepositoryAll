...
public class MultiReward_Activity extends Activity implements View.OnClickListener {
    ...
    public void onStart() {
        ...
        final String url = "http://" + FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpHeaderImageUrl");
        ...
        public void smsoffer(final RewardsItem item, final ViewGroup currentView) {
            ...
            if (sendSMS != null && print != null) {
                if (buttoncolor != null) {
                    ...
                    sendSMS.setBackgroundColor(Color.parseColor(btncolor));
...
//                });
            ...
            sendSMS.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    created = FB_LY_UserService.sharedInstance().member.emailID;
                    if(StringUtilities.isValidString(item.getCompaignDescription())) {
                        sendPassEmail(item.getCompaignTitle(), item.getCompaignDescription(), created);
                    }
                }
            });
