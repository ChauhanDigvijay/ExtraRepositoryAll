...
public class FragmentThemeSignUpDynamic extends Fragment implements View.OnClickListener {
    ...
    public TextView regissubtxt_name;
    ...
    //List<CheckBox> allchecks = new ArrayList<CheckBox>();
    //public Map<String, EditText> allmapEd = new HashMap<String, EditText>();//storesMap
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        regissubtxt_name = (TextView) v.findViewById(R.id.regissubtxt_name);
        ...
        if(alldps.size() >0)
        {
            ...
            for (FBThemeRegistrationField registerfield : registerFields) {
                if (registerfield.customField) {
                    if (registerfield.profileFieldType.equalsIgnoreCase("date")) {
    ...
    public void configureField() {
        ...
        for (FBThemeRegistrationField registerfield : registerFields) {
            ...
            if (registerfield.name.equalsIgnoreCase("FirstName")) {
                ...
                creatTextField("ZipCode", registerfield.displayName,registerfield);
            } else if (registerfield.name.equalsIgnoreCase("FavoriteStore")) {
                creatTextField("Favourite Location", registerfield.displayName,registerfield);
            } else if (registerfield.name.equalsIgnoreCase("City")) {
                creatTextField("City", registerfield.displayName,registerfield);
                ...
                creatTextField("EmailAddress", registerfield.displayName,registerfield);
            } else if (registerfield.name.equalsIgnoreCase("DOB")) {
                creatTextFieldforcalendra("DOB", registerfield.displayName);
            }
...
//            }
                ...
                creatTextField("State", registerfield.displayName,registerfield);
            } else if (registerfield.name.equalsIgnoreCase("PhoneNumber")) {
                final EditText editText = creatTextField("PhoneNumber", registerfield.displayName,registerfield);
            ...
            } else if (registerfield.name.equalsIgnoreCase("Password")) {
                creatTextField("Password", registerfield.displayName,registerfield);
            }
...
//            }
            ...
            } else if (registerfield.name.equalsIgnoreCase("Bonus")) {
            ...
            else if (registerfield.customField )
            {
                if(StringUtilities.isValidString(registerfield.profileFieldType))
                {
                    if (registerfield.profileFieldType.equalsIgnoreCase("text")) {
                        ...
                        creatDropDown("customeField", registerfield.displayName,registerfield.optionListdisplayname,registerfield);
                    }
...
//        }
    ...
    public void creatRadioButton(String name,String desc,FBThemeRegistrationField registerfield) {
        ...
        if (name.equals("SMSOptIn")) {
            SMSOptIn = checkBox;
            SMSOptIn.setChecked(Boolean.valueOf(registerfield.defaultValue));
        ...
        if (name.equals("Opt-in to receive VIP email offers")) {
            EmailOptIn = checkBox;
            EmailOptIn.setChecked(Boolean.valueOf(registerfield.defaultValue));
            //  textview.setText(desc);
...
//        }
        ...
        if (name.equals("customeFieldRadio")) {
            ...
            customeFieldRadio.setChecked(Boolean.valueOf(registerfield.defaultValue));
    ...
    public void creatCustomTimePicker(String name,String desc,final FBThemeRegistrationField registerfield) {

        LinearLayout view;
        LayoutInflater mInflater = (LayoutInflater) getContext().getSystemService(getContext().LAYOUT_INFLATER_SERVICE);
        view = (LinearLayout) mInflater.inflate(R.layout.customtimepicker, null, false);
        ...
        editText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if(v.getTag().toString().equalsIgnoreCase( registerfield.databaseName))
    ...
    public void creatDropDown(String name,String desc,ArrayList<String> optionListdisplayname,FBThemeRegistrationField registerfield) {
        ...
        LinearLayout view;
        // optionListdisplayname.add(0, desc);
        LayoutInflater mInflater = (LayoutInflater) getContext().getSystemService(getContext().LAYOUT_INFLATER_SERVICE);
        view = (LinearLayout) mInflater.inflate(R.layout.signup_dropdown, null, false);
...
//                    object.put("country",Country.getText().toString());
                            ...
                            if(allchecks.size() >0)
                            {
                                ...
                                {
                                    CheckBox cb = allchecks.get(i);
                                    if(cb.getTag().toString().equalsIgnoreCase(registerfield.databaseName))
                                    {
                            ...
                            if(alldps.size() >0)
                            {
                                ...
                                for (int i = 0; i < alldps.size(); i++)
                                {
                                    EditText dp = alldps.get(i);
                                    if(dp.getTag().toString().equalsIgnoreCase(registerfield.databaseName))
                                    {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //signup tiltle/subtitle  text
        if (StringUtilities.isValidString(FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpHeadingText"))) {
            registxt_name.setText(FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpHeadingText"));
        }
        if (StringUtilities.isValidString(FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpPageTaglineText"))) {
            regissubtxt_name.setText(FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpPageTaglineText"));
        }


        //signup tiltle/subtitle  textcolor
        //String buttoncolor =  FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonType1NormalColor");
        String signUpHeadingColor =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpHeadingColor");
        if (signUpHeadingColor != null) {
            registxt_name.setTextColor(Color.parseColor(signUpHeadingColor));

        }
        //String buttoncolor =  FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonType1NormalColor");
        String signUpPageTaglineColor =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpPageTaglineColor");
        if (signUpPageTaglineColor != null) {
            regissubtxt_name.setTextColor(Color.parseColor(signUpPageTaglineColor));


        }


        //signup tiltle/subtitle  textsize
        String signUpHeadingSize =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpHeadingSize");
        if(StringUtilities.isValidString(signUpHeadingSize)) {
            registxt_name.setTextSize(TypedValue.COMPLEX_UNIT_SP, Float.parseFloat(signUpHeadingSize));
        }
        String signUpPageTaglineSize =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpPageTaglineSize");
        if(StringUtilities.isValidString(signUpPageTaglineSize)) {
            regissubtxt_name.setTextSize(TypedValue.COMPLEX_UNIT_SP, Float.parseFloat(signUpPageTaglineSize));
        }
        ...
        //signup  reamining text color
        String buttoncolor = FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonStateFontColor");
        if (buttoncolor != null) {
            String btncolor =  buttoncolor;
            ...
            registration_button.setTextColor(Color.parseColor(btncolor));
        }


        String signUpHeadingBold =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpHeadingBold");
        if (StringUtilities.isValidString(signUpHeadingBold)) {
            if (signUpHeadingBold.equalsIgnoreCase("1"))
                registxt_name.setTypeface(null, Typeface.BOLD);
        }

        String signUpHeadingItalic =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpHeadingItalic");
        if (StringUtilities.isValidString(signUpHeadingItalic)) {
            if (signUpHeadingItalic.equalsIgnoreCase("1"))
                registxt_name.setTypeface(null, Typeface.ITALIC);
        }

        String signUpHeadingUnderline =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpHeadingUnderline");
        if (StringUtilities.isValidString(signUpHeadingUnderline)) {
            if (signUpHeadingUnderline.equalsIgnoreCase("1"))
                registxt_name.setPaintFlags(Paint.UNDERLINE_TEXT_FLAG);
        }
        ...
        String signUpPageTaglineBold =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpPageTaglineBold");
        if (StringUtilities.isValidString(signUpPageTaglineBold)) {
            if (signUpPageTaglineBold.equalsIgnoreCase("1"))
                regissubtxt_name.setTypeface(null, Typeface.BOLD);
        }

        String signUpPageTaglineItalic =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpPageTaglineItalic");
        if (StringUtilities.isValidString(signUpPageTaglineItalic)) {
            if (signUpPageTaglineItalic.equalsIgnoreCase("1"))
                regissubtxt_name.setTypeface(null, Typeface.ITALIC);
        }

        String signUpPageTaglineUnderline =  FBThemeMobileSettingsService.sharedInstance().registermapsetting.get("SignUpPageTaglineUnderline");
        if (StringUtilities.isValidString(signUpPageTaglineUnderline)) {
            if (signUpPageTaglineUnderline.equalsIgnoreCase("1"))
                regissubtxt_name.setPaintFlags(Paint.UNDERLINE_TEXT_FLAG);
        }
...
//        }
            ...
            } else if (registerfield.required && registerfield.name.equalsIgnoreCase("Password")) {
                if (!FBUtils.isValidString(Password.getText().toString())) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_Text:
                ...
                editText.setBackgroundColor(Color.parseColor("#" + FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonType1NormalColor")));
            ...
            case R.id.btn_Text1:
                ...
                editText1.setBackgroundColor(Color.parseColor("#" + FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonType1NormalColor")));
