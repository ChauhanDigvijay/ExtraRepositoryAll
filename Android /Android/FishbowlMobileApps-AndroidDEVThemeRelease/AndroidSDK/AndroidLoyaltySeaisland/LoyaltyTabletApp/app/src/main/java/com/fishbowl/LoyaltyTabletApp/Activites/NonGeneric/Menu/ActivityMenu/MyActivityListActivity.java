...
public class MyActivityListActivity extends FragmentActivity implements View.OnClickListener {
    Button log;
    ...
    public void inititateui() {
        ...
        mImageLoader.get(url, ImageLoader.getImageListener(titlebackground, R.drawable.signup, R.drawable.signup));
        ...
        layout_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MyActivityListActivity.this, MenuActivity.class);
                startActivity(i);
            }
        });
        ...
        layout_loyalty.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MyActivityListActivity.this, HomeActivity.class);
                startActivity(i);
            }
        });
    ...
    public void logout() {
        AlertDialog alertDialog = new AlertDialog.Builder(MyActivityListActivity.this).create();
        ...
        alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(MyActivityListActivity.this, SignInActivity.class);
