...
// */
//
//public class CBCMainActivity extends Activity implements View.OnClickListener, FBSdk.OnFBSdkRegisterListener {
//    Button bbl;
//
//    Bundle extras;
...
//
//                    Constants.alertDialogShow(CBCMainActivity.this,"GetToken Success Message");
//
//                    mobileSettings();
//
//                }else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"GetToken Error Message");
//
//                }
//
//            }
...
//                    Constants.alertDialogShow(CBCMainActivity.this, "MobileSettingsService Success Message" + state);
//                    getViewMobileSettingsServiceSettings();
//                }
//                else{
//                    Constants.alertDialogShow(CBCMainActivity.this, "MobileSettingsService Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this, error);
//                }
//            }
//        });
//    }
...
//                if(error==null&&response!=null){
//
//                    Constants.alertDialogShow(CBCMainActivity.this,"MobileSettingsService Success Message"+response);
...
//        try {
//
//            object.put("username","997-168-1444");
...
//                if(error==null&&response!=null){
//                    try {
//                        Constants.alertDialogShow(CBCMainActivity.this,"loginMember Success Message"+response);
//                        String secratekey=response.getString("accessToken");
//                        FBPreferences.sharedInstance(CBCMainActivity.this).setAccessTokenforapp(secratekey);
//                        FBUserService.sharedInstance().access_token = response.getString("accessToken");
//                        FBPreferences.sharedInstance(CBCMainActivity.this).setSignin(true);
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
//                    CheckTwentyApi();
//
//                }else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"loginMember Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//            }
//
...
//
//
//                    Constants.alertDialogShow(CBCMainActivity.this,"getMember Success Message"+response.toString());
//                    //  deviceUpdate();
//                    getAllStores();
//                    // getUserLogout();
//                    // getMenuCategory();
//                }else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getMember Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//            }
//
...
//            Constants.alertDialogShow(CBCMainActivity.this,"MemberID of user "+FBPreferences.sharedInstance(this).getUserMemberforAppId());
//            object.put("deviceId", FBUtility.getAndroidDeviceID(this));
...
//            Constants.alertDialogShow(CBCMainActivity.this,"GCM Push token of user "+FBPreferences.sharedInstance(this).getPushToken());
...
//                if(error==null&&response!=null){
//                    try {
//                        Constants.alertDialogShow(CBCMainActivity.this,"deviceUpdate Success Message"+response);
//                        EventCheck();
//                        //  memberUpdate();
//                        GetMember();
//
...
//
//                else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"deviceUpdate Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//            }
//        });
...
//                if(error==null&&response!=null) {
//                    Constants.alertDialogShow(CBCMainActivity.this,"memberUpdate Success Message"+response);
//
//                    GetMember();
//                }
//                else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"memberUpdate Error Message"+" --"+error);
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//            }
//        });
...
//
//                if(error==null&&response!=null){
//                    Constants.alertDialogShow(CBCMainActivity.this,"getMember Success Message"+ response);
//                    //  getAllStores();
//                    getUserLogout();
//                    //getMenuCategory();
//                }else {
...
//
//                if(error==null&&response!=null){
//                    Constants.alertDialogShow(CBCMainActivity.this,"getAllStore Success Message");
//                    StoreDetails();
//                }
//                else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getAllStore Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//            }
//        });
...
//
//        FBStoreService.sharedInstance().getStoreDetails("141284",new FBStoreService.FBStoreDetailCallback() {
//            @Override
//            public void OnFBStoreDetailCallback( JSONObject response, Exception error) {
//
//                if(error==null&&response!=null){
//                    Constants.alertDialogShow(CBCMainActivity.this,"StoreDetails Success Message"+response);
//                    favouriteStoreUpdate();
//                }
//                else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"StoreDetails Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//
//            }
...
//        try
//        {
//            object.put("memberid",FBPreferences.sharedInstance(CBCMainActivity.this).getUserMemberforAppId());
//            object.put("storeCode","141284");
//
//        }catch (Exception e){
//            e.printStackTrace();
//        }
...
//                if(error==null&&response!=null){
//
//                    Constants.alertDialogShow(CBCMainActivity.this,"favourteStoreUpdate Success Message"+response);
//                    getMenuCategory();
//
//                }else {
//
//                    Constants.alertDialogShow(CBCMainActivity.this,"favourteStoreUpdate Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//
//            }
...
//        final JSONObject object = new JSONObject();
//        FBUserService.sharedInstance().getMenuCategory(object, String.valueOf(141289),
...
//                            if(error==null&&response!=null){
//
//                                Constants.alertDialogShow(CBCMainActivity.this,"getMenuCategory Success Message"+response);
//                                getMenuSubCategory();
//                            }
//                            else {
//                                Constants.alertDialogShow(CBCMainActivity.this,"getMenuCategory Error Message");
//                                FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                            }
//                        } catch (Exception e) {
//
...
//
//        final JSONObject object = new JSONObject();
//        FBUserService.sharedInstance().getMenuSubCategory(object, String.valueOf(141284), String.valueOf(22), new FBUserService.FBMenuSubCategoryCallback() {
//
//            public void onMenuSubCategoryCallback(JSONObject response, Exception error) {
//                try {
//                    if(error==null&&response!=null){
//
//                        Constants.alertDialogShow(CBCMainActivity.this,"getMenuSubCategory Success Message"+response);
//                        getMenuDrawerListProduct();
//                    }
//                    else {
//                        Constants.alertDialogShow(CBCMainActivity.this,"getMenuSubCategory Error Message");
//                        FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                    }
//                } catch (Exception e) {
//
...
//
//        final JSONObject object = new JSONObject();
//        FBUserService.sharedInstance().getDrawerProductList(object, String.valueOf(141284), String.valueOf(22),String.valueOf(223), new FBUserService.FBMenuDrawerCallback() {
//
//            public void onMenuDrawerCallback(JSONObject response, Exception error) {
//                try {
//                    if(error==null&&response!=null){
//                        Constants.alertDialogShow(CBCMainActivity.this,"getDrawerProductList Success Message"+response);
//                        getMenuProductDetail();
//                    }
//                    else {
//                        Constants.alertDialogShow(CBCMainActivity.this,"getDrawerProductList Error Message");
//                        FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                    }
//                } catch (Exception e) {
//
...
//
//        final JSONObject object = new JSONObject();
//        FBUserService.sharedInstance().getMenuProduct(object, String.valueOf(141284), String.valueOf(22),String.valueOf(223), String.valueOf(1017), new FBUserService.FBMenuProductCallback() {
//
//            public void onMenuProductCallback(JSONObject response, Exception error) {
//                try {
//                    if(error==null&&response!=null){
//
//                        Constants.alertDialogShow(CBCMainActivity.this,"getMenuProduct Success Message"+response);
//                        getUserOffers();
//                    }
//                    else {
//                        Constants.alertDialogShow(CBCMainActivity.this,"getMenuProduct Error Message");
//                        FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                    }
//                } catch (Exception e) {
//
...
//                if(error==null&&response!=null) {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getUserFBOffer Success Message"+response);
//                    getUserReward();
//                }
//                else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getUserFBOffer Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//            }
//        });
...
//                if(error==null&&response!=null) {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getUserFBReward Success Message"+response);
//                    getUserFBPointBankOffer();
//                }
//                else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getUserFBReward Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//            }
//        });
...
//                if(error==null&&response!=null) {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getUserFBPointBankOffer Success Message"+response);
//                    useOffer();
//                }
//                else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getUserFBPointBankOffer Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                }
//            }
//        });
...
//                if(error==null&&response!=null) {
//
//                    Constants.alertDialogShow(CBCMainActivity.this,"useOffer Success Message"+response);
//                    getBonusRuleList();
//                }else {
//                    Constants.alertDialogShow(CBCMainActivity.this,"useOffer Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//                    getBonusRuleList();
//                }
//            }
...
//                {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getBonusRuleList Success Message"+response);
//
//                    getUserLogout();
//                }
//                else
//                {
//                    Constants.alertDialogShow(CBCMainActivity.this,"getBonusRuleList Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//
//                }
//            }
...
//                if (response != null && error==null)
//                {
//                    Constants.alertDialogShow(CBCMainActivity.this, "Congratution logout Success Message"+response);
//
//                }
//                else
//                {
//                    Constants.alertDialogShow(CBCMainActivity.this,"logout Error Message");
//                    FBUtils.tryHandleTokenExpiry(CBCMainActivity.this,error);
//
//                }
//
