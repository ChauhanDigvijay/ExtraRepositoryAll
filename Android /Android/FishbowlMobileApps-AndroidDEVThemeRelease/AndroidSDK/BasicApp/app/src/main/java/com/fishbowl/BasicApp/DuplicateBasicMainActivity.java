...
// */
//
//public class DuplicateBasicMainActivity extends Activity implements View.OnClickListener, FBSdk.OnFBSdkRegisterListener {
//    Button bbl;
//
//    Bundle extras;
...
//
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"GetToken Success Message");
//
//                    mobileSettings();
//
//                }else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"GetToken Error Message");
//
//                }
//
//            }
...
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this, "MobileSettingsService Success Message" + state);
//                    getViewMobileSettingsServiceSettings();
//                }
//                else{
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this, "MobileSettingsService Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this, error);
//                }
//            }
//        });
//    }
...
//                if(error==null&&response!=null){
//
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"MobileSettingsService Success Message"+response);
...
//        try {
//
//            object.put("username","956-071-7227");
...
//                if(error==null&&response!=null){
//                    try {
//                        Constants.alertDialogShow(DuplicateBasicMainActivity.this,"loginMember Success Message"+response);
//                        String secratekey=response.getString("accessToken");
//                        FBPreferences.sharedInstance(DuplicateBasicMainActivity.this).setAccessTokenforapp(secratekey);
//                        FBUserService.sharedInstance().access_token = response.getString("accessToken");
//                        FBPreferences.sharedInstance(DuplicateBasicMainActivity.this).setSignin(true);
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
//                    CheckTwentyApi();
//
//                }else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"loginMember Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//            }
//
...
//
//
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMember Success Message"+response.toString());
//                    deviceUpdate();
//                }else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMember Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//            }
//
...
//            Constants.alertDialogShow(DuplicateBasicMainActivity.this,"MemberID of user "+FBPreferences.sharedInstance(this).getUserMemberforAppId());
//            object.put("deviceId", FBUtility.getAndroidDeviceID(this));
...
//            Constants.alertDialogShow(DuplicateBasicMainActivity.this,"GCM Push token of user "+FBPreferences.sharedInstance(this).getPushToken());
...
//                if(error==null&&response!=null){
//                    try {
//                        Constants.alertDialogShow(DuplicateBasicMainActivity.this,"deviceUpdate Success Message"+response);
//                        EventCheck();
//                        memberUpdate();
//                    } catch (Exception e) {
//                        e.printStackTrace();
...
//
//                else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"deviceUpdate Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//            }
//        });
...
//                if(error==null&&response!=null) {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"memberUpdate Success Message"+response);
//
//                    GetMember();
//                }
//                else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"memberUpdate Error Message"+" --"+error);
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//            }
//        });
...
//
//                if(error==null&&response!=null){
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMember Success Message"+ response);
//                    getAllStores();
//                }else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMember Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
...
//
//                if(error==null&&response!=null){
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getAllStore Success Message");
//                    StoreDetails();
//                }
//                else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getAllStore Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//            }
//        });
...
//
//                if(error==null&&response!=null){
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"StoreDetails Success Message"+response);
//                    favouriteStoreUpdate();
//                }
//                else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"StoreDetails Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//
//            }
...
//        try
//        {
//            object.put("memberid",FBPreferences.sharedInstance(DuplicateBasicMainActivity.this).getUserMemberforAppId());
...
//                if(error==null&&response!=null){
//
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"favourteStoreUpdate Success Message"+response);
//                    getMenuCategory();
//
//                }else {
//
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"favourteStoreUpdate Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//
//            }
...
//                            if(error==null&&response!=null){
//
//                                Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMenuCategory Success Message"+response);
//                                getMenuSubCategory();
//                            }
//                            else {
//                                Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMenuCategory Error Message");
//                                FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                            }
//                        } catch (Exception e) {
//
...
//                    if(error==null&&response!=null){
//
//                        Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMenuSubCategory Success Message"+response);
//                        getMenuDrawerListProduct();
//                    }
//                    else {
//                        Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMenuSubCategory Error Message");
//                        FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                    }
//                } catch (Exception e) {
//
...
//                try {
//                    if(error==null&&response!=null){
//                        Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getDrawerProductList Success Message"+response);
//                        getMenuProductDetail();
//                    }
//                    else {
//                        Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getDrawerProductList Error Message");
//                        FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                    }
//                } catch (Exception e) {
//
...
//                    if(error==null&&response!=null){
//
//                        Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMenuProduct Success Message"+response);
//                        getUserOffers();
//                    }
//                    else {
//                        Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getMenuProduct Error Message");
//                        FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                    }
//                } catch (Exception e) {
//
...
//                if(error==null&&response!=null) {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getUserFBOffer Success Message"+response);
//                    getUserReward();
//                }
//                else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getUserFBOffer Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//            }
//        });
...
//                if(error==null&&response!=null) {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getUserFBReward Success Message"+response);
//                    getUserFBPointBankOffer();
//                }
//                else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getUserFBReward Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//            }
//        });
...
//                if(error==null&&response!=null) {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getUserFBPointBankOffer Success Message"+response);
//                    useOffer();
//                }
//                else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getUserFBPointBankOffer Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                }
//            }
//        });
...
//                if(error==null&&response!=null) {
//
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"useOffer Success Message"+response);
//                    getBonusRuleList();
//                }else {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"useOffer Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//                    getBonusRuleList();
//                }
//            }
...
//                {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getBonusRuleList Success Message"+response);
//
//                    getUserLogout();
//                }
//                else
//                {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"getBonusRuleList Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//
//                }
//            }
...
//                if (response != null && error==null)
//                {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this, "Congratution logout Success Message"+response);
//
//                }
//                else
//                {
//                    Constants.alertDialogShow(DuplicateBasicMainActivity.this,"logout Error Message");
//                    FBUtils.tryHandleTokenExpiry(DuplicateBasicMainActivity.this,error);
//
//                }
//
