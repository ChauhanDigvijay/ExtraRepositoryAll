...
public class MenuActivity extends Activity  implements View.OnClickListener{
    ...
    final String faqlink = "http://" + FB_LY_MobileSettingService.sharedInstance().faq;
...
//                startActivity(i);
                ...
                WebViewActivity.show(MenuActivity.this, "DJ", faqlink);
              //  "http://" + FB_LY_MobileSettingService.sharedInstance().faq;
