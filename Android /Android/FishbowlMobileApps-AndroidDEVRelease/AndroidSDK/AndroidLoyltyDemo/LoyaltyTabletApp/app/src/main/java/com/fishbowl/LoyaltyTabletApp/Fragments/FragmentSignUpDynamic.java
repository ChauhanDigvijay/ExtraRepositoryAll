...
public class FragmentSignUpDynamic extends Fragment implements View.OnClickListener {
    ...
    Boolean rewardRule;
    int ruleId;
    final String privacylink = "http://" + FB_LY_MobileSettingService.sharedInstance().privacyContent;
    final String termslink = "http://" + FB_LY_MobileSettingService.sharedInstance().termsAndConditions;
...
//                startActivity(ii);
                WebViewActivity.show(getActivity(), "DJ", termslink);
            }
        });
...
//                startActivity(ii);
                ...
                WebViewActivity.show(getActivity(), "DJ", privacylink);
            }
        });
