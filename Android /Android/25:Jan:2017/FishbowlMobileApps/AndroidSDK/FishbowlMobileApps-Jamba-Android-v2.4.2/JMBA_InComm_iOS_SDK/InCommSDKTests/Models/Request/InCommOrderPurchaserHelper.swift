...
class InCommOrderPurchaserHelper {
    ...
    class func createOrderPurchaserWithDiffrentiatingNumber(_ num: Int) -> InCommOrderPurchaser {
    ...
    class func testOrderPurchaser(_ orderPurchaser: InCommOrderPurchaser) {
        testOrderPurchaserJSONDict(orderPurchaser.serializeAsJSONDictionary(), orderPurchaser: orderPurchaser)
    }
    
    class func testOrderPurchaserJSONDict(_ orderPurchaserJSONDict: InCommJSONDictionary, orderPurchaser: InCommOrderPurchaser) {
        ...
        XCTAssertEqual(orderPurchaser.userId, (orderPurchaserJSONDict["UserId"] as? NSNumber)?.int32Value, "UserId should have been same")
