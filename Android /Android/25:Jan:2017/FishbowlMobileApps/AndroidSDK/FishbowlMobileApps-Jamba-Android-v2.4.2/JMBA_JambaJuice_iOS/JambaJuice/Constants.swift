...
struct Constants {
    ...
    static let jambaMediumGrayColor    = 0x9C9B9B
    ...
    static let jambaCancelOrderRedColor   = 0xFF0000
    ...
    static let parseRemoteSyncPeriod: TimeInterval = 24 * 60 * 60         // 24 hr
    ...
    static let homeScreenNavigationMenuHeight: CGFloat = 60                // Height of the Navigation Menu on the home screen
    static let productThumbAspectRatio: CGFloat = 1.2621951219512195        // Aspect ratio for product thumbnails (621/492)
    static let adImageAspectRatio: CGFloat = 0.56
    //Ad Image aspect ration
    ...
    // Animations
    static let basketNCAnimationTime: TimeInterval = 0.5
