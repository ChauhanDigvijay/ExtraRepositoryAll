     ...
     @IBAction func continueSignUp() {
        // Per legal requirements, confirm for opt-in twice
         if personalizedUpdatesSwitch.isOn {
            presentConfirmation("Push Notification", message: "I agree to receive personalized updates and offers via push notifications.", buttonTitle: "Agree", callback: { (confirmed) -> Void in
                if !confirmed {
