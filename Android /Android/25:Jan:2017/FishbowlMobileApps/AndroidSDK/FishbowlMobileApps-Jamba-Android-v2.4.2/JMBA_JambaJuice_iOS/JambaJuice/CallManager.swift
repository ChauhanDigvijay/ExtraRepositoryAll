...
class CallManager {
    ...
    class func call(_ phoneNumber: String, presentingViewController viewController: UIViewController) {
        if let telURL = URL(string: "tel://\(phoneNumber.stringByRemovingNonNumericCharacters())") {
