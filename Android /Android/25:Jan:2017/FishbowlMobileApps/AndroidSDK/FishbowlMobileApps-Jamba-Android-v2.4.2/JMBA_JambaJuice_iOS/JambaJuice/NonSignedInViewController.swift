...
class NonSignedInViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        signUpLabelMutableString  = NSMutableAttributedString(string: signUpLabelString as String, attributes: [NSAttributedStringKey.font:UIFont.init(name: "Archer-Medium", size: 14.0)!])
        
        let color = UIColor(red: 201.0/255.0, green: 54.0/255.0, blue: 47.0/255.0, alpha: 1.0);
        
        signUpLabelMutableString.addAttribute(NSAttributedStringKey.foregroundColor, value: color, range: NSRange(location:23,length:7))
