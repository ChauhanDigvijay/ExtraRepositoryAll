...
class SignUpStepsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        termsLabel.attributedText = NSAttributedString(string: termsLabel.text!, attributes: [NSAttributedStringKey.underlineStyle: NSUnderlineStyle.styleSingle.rawValue])
    }
