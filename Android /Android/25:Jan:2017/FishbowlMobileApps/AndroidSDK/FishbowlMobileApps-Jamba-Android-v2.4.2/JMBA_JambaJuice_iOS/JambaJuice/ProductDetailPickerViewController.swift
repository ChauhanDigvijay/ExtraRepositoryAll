...
//  JambaJuice
//
//  Created by vThink Technologies on 19/11/16.
...
class ProductDetailPickerViewController: UIViewController,UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func setMaxQuantity(_ maxValue:Int) {
        pickerData = []
    ...
    @IBAction func savePickerValue() {
        let res:String = "\(pickerData[picker.selectedRow(inComponent: 0)])"
