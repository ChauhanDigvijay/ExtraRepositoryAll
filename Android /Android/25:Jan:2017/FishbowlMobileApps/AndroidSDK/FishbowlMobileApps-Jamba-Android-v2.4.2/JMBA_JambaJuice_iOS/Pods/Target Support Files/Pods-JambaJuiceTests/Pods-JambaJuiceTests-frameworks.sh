...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/FishbowlFramework/FishBowlLibrary.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HDK/HDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/InCommSDK/InCommSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/OloSDK/OloSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Parse/Parse.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SVProgressHUD/SVProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SpendGoSDK/SpendGoSDK.framework"
