...
public class PurchaseNewCardActivityGiftCard extends GiftCardBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (GiftCardDataManager.getInstance().getBrands() != null
                && GiftCardDataManager.getInstance().getBrands().size() > 0
                && GiftCardDataManager.getInstance().getBrands().get(0).getCardImages() != null
                && GiftCardDataManager.getInstance().getBrands().get(0).getCardImages().size() > 0) {
