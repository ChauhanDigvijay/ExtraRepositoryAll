...
//    }
    ...
    protected BroadcastReceiver broadcastReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            else if(intent.getAction().equals(Constants.BROADCAST_UPDATE_GF_HOME_ACTIVITY))
            {
                handleUpdateGiftCardLists(intent);
            }else if(intent.getAction().equals(Constants.BROADCAST_GF_HOME_ACTIVITY_REFRESH_UI)){
