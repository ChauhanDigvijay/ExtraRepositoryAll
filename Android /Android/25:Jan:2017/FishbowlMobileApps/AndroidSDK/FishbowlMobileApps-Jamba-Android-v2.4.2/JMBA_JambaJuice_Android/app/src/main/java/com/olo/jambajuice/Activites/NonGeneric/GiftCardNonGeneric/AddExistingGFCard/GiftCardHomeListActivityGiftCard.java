...
public class GiftCardHomeListActivityGiftCard extends GiftCardBaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(mContext).registerReceiver(broadcastReceiver, new IntentFilter(Constants.BROADCAST_UPDATE_GF_HOME_ACTIVITY));
        LocalBroadcastManager.getInstance(mContext).registerReceiver(broadcastReceiver, new IntentFilter(Constants.BROADCAST_GF_HOME_ACTIVITY_REFRESH_UI));
