...
public class AddCardActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
    ...
    private SemiBoldTextView addNewCardView;
...
//    }
    ...
    private void setUpView() {
        ...
        payInfoLayout = (LinearLayout) findViewById(R.id.payInfoLayout);
        addNewCardView = (SemiBoldTextView) findViewById(R.id.addNewCardView);
