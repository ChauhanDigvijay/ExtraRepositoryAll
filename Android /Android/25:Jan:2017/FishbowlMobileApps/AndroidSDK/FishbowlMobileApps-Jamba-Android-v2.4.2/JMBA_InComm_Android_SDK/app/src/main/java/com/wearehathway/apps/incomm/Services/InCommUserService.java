...
import static com.wearehathway.apps.incomm.Services.InCommCardService.VolleyFailure_UnAuthorizedMessage;
...
public class InCommUserService {
    ...
    private static void userIdService(String path, final InCommUserServiceCallBack callback){
        ...
        if(InCommService.getInstance() != null) {
            ...
            callback.onUserServiceCallback(null,new Exception(VolleyFailure_UnAuthorizedMessage));
        }
    }
