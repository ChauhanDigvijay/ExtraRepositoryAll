...
class OloRestaurantCustomFieldTests: OloTestCase {
    ...
    func helperRestaurantCustomFieldDictionaryArrayWithCount(_ count: Int) -> Array<[String:AnyObject]> {
    ...
    func helperRestaurantCustomFieldDictionaryWithIndex(_ index: Int) -> [String:AnyObject] {
        let dict: [String:AnyObject] = [
            "id": index as AnyObject,
            "label": "label_\(index)" as AnyObject,
            "required": (index % 2 == 0) as AnyObject,
            "validationregex": "11122233\(index)" as AnyObject,
            "qualificationcriteria": "11122233\(index)" as AnyObject,
        ]
        return dict
    }
    
    func helperCompareRestaurantCustomFieldWithDictionary(_ restaurantCustomField: OloRestaurantCustomField, dictionary:[String: AnyObject]) {
