...
-(void)startSoapTool:(int)__status{
    ...
    [headers setObject:[NSString stringWithFormat:@"http://tempuri.org/%@/%@",serviceName,functionName] forKey:@"SOAPAction"];
...
-(void)serviceDone{
    ...
    [delegate callBackWithData:resultArray];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    if(connection == theConnection)
    {
        ...
        parser = [[XmlParser alloc]initWithData:tmp_Data];
