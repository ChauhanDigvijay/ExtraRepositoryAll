...
public class FBService {
	...
	private void makePassRequest(int method, String url, String params, HashMap<String, String> _header, final FBPassCallback callback, int requestTimeOut){
	...
	public void makeCustomPassRequest(String path, String JsonEntity, HashMap<String, String> _header, final FBPassCallback callback){
	...
	public void loginMemberforproduction(JSONObject parameter,final FBLoginMemberCallback callback){
		boolean dj=false;
		String url = "https://jamba.clyptechs.com/clpapi/mobile/stores/getstores";
		String str=parameter.toString();
		FBService.getInstance().get(url, null, getHeader23(), dj,new FBServiceCallback(){
...
////		boolean dj = false;
////		String str=parameter.toString();
//		String url = "https://jamba.clyptechs.com/clpapi/mobile/getToken";
//		JSONObject object=new JSONObject();
//		try {
...
//				params.put("secret","91225258ddb5c8503dce33719c5deda7");
//				return params;
//			}
//			@Override
//			public Map<String, String> getHeaders() throws AuthFailureError {
