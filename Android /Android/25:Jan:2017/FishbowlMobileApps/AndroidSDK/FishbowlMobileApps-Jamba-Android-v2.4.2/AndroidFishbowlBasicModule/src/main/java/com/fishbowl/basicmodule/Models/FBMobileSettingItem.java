 ...
 */
public class FBMobileSettingItem implements Serializable {
    ...
    public FBMobileSettingItem() {
    }


    public FBMobileSettingItem(long dISTANCE_FILTER, float dISTANCE_STORE,
