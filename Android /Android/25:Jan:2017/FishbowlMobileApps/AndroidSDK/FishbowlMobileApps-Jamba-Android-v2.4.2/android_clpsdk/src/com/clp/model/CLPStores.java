...
public class CLPStores implements Serializable{
	...
	public CLPStores(){}
	public CLPStores(JSONObject obj)
	{
		try
		{
			
			storeID = obj.has("storeID") ? obj.getInt("storeID") : 0;
			companyID = obj.has("companyID") ? obj.getInt("companyID") : 0;
			...
			storeNumber =obj.has("storeNumber")? obj.getInt("storeNumber"):0;
