...
public class FBEventSettings implements Serializable {
   ...
   public ArrayList<FBEventModel> modelList=new ArrayList<FBEventModel>();
	...
	//Event related to rewards
	public static final String  OPEN_APP_REWARD="OPEN_APP_REWARD";
	public static final String  ACCEPT_REWARD="ACCEPT_REWARD";
	public static final String  ACCEPT_APP_REWARD="ACCEPT_APP_REWARD";

	public static final String  GIFT_CARD_CREATED_OTHERS="GIFT_CARD_CREATED_OTHERS";
	public static final String  GIFT_CARD_CREATED_SELF="GIFT_CARD_CREATED_SELF";

	public static final String  GIFT_CARD_RELOAD="GIFT_CARD_RELOAD";
	public static final String  GIFT_CARD_AUTORELOAD_CREATED="GIFT_CARD_AUTORELOAD_CREATED";

	public static final String  GIFT_CARD_AUTORELOAD_DISABLED="GIFT_CARD_AUTORELOAD_DISABLED";
	public static final String   GIFT_CARD_AUTORELOAD_ENABLED=" GIFT_CARD_AUTORELOAD_ENABLED";

	public static final String  GIFT_CARD_AUTORELOAD_REMOVED="GIFT_CARD_AUTORELOAD_REMOVED";
	public static final String  GIFT_CARD_ADDED="GIFT_CARD_ADDED";


	public static final String  GIFT_CARD_REMOVED="GIFT_CARD_REMOVED";
	public static final String  GIFT_CARD_PROMO_CREATED="GIFT_CARD_PROMO_CREATED";
