...
public class FBLocationService {
	...
	public void locationUpdateDevice(FBMobileEventsItem mobileEvents) {
	...
	protected void checkInsideNearestStoreRegion(Location userLocation) {
		...
		for (FBStoresItem geoStores : fbSdk.getAllStoreList()) {
	...
	public interface FBlocationUpdateDeviceCallback {
