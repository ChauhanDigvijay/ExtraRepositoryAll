...
public class FBSdk {
    ...
    private static FBSdkData FBSdkData;
    ...
    public interface OnFBSdkRegisterListener {
        public void onFBRegistrationSuccess(String success);
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (StringUtilities.isValidString(mPushToken)) {
                    ...
                    sdkListener.onFBRegistrationSuccess(mPushToken);// we can used this callback when token is update again.
                } else {
    ...
    private void createNotificationMessage(Intent payloadIntent) {
        ...
        try {
            if (StringUtilities.isValidString(payloadString)) {
                {
