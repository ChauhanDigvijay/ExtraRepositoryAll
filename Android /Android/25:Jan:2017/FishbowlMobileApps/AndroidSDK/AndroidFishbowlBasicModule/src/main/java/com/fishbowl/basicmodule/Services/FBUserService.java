...
public class FBUserService {
    ...
    public void createMember(JSONObject parameter, final FBCreateMemberCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onCreateMemberCallback(null, FBUtility.getNetworkError());
            } else {

                String str = parameter.toString();

                FBService.getInstance().post(FBConstant.FBCreateMemberApi, str, getHeaderregistration(), new FBServiceCallback() {
    ...
    public void createMemberUpdatebyEmail(JSONObject parameter, final FBCreateMemberCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                ...
                FBService.getInstance().post(FBConstant.FBCreateMemberUpdatebyEmailApi, str, getHeaderregistration(), new FBServiceCallback() {
    ...
    public void loginMember(JSONObject parameter, final FBLoginMemberCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onLoginMemberCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    public void getMember(JSONObject parameter, final FBGetMemberCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onGetMemberCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    public void memberUpdate(JSONObject parameter, final FBMemberUpdateCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onMemberUpdateCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    public void deviceUpdate(JSONObject parameter, final FBDeviceUpdateCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onDeviceUpdateCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    public void changePassword(JSONObject parameter, final FBChangePasswordCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onChangePasswordCallback(null, FBUtility.getNetworkError());
            } else {
    ...
    public void forgetPassword(JSONObject parameter, final FBforgetPasswordCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onFBforgetPasswordCallback(null, FBUtility.getNetworkError());
            } else {
    ...
    public void favourteStoreUpdate(JSONObject parameter, final FBFavouriteStoreUpdateCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onFBFavouriteStoreUpdateCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    public void getState(JSONObject parameter, final FBStateCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onStateCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    public void getCountry(JSONObject parameter, final FBCountryCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onCountryCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    public void logout(JSONObject parameter, final FBLogoutCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onLogoutCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    public void contactUs(JSONObject parameter, final FBContactUsCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onContactUsCallback(null, FBUtility.getNetworkError());
            } else {
    ...
    public void getBonusRuleList(JSONArray parameter, final FBBonusRuleListCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onBonusRuleListCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
                boolean dj = true;
    ...
    public void getFamilyApi(JSONObject parameter, String storeId, final FBFamilyApiCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onFamilyApiCallback(null, FBUtility.getNetworkError());
            } else {
...
//    }
    ...
    public void getMenuCaegorySubCategoryCallback(JSONObject parameter, String storeId, String familyId, final FBMenuCategorySubCategoryCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onMenuCategorySubCategoryCallback(null, FBUtility.getNetworkError());
            } else {
    ...
    public void getMenuProductList(JSONObject parameter, String storeId, String familyId, String categoryId, final FBMenuCategoryProductListCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onMenuCategoryProductListCallback(null, FBUtility.getNetworkError());
            } else {
    ...
    public void getAllRewardOfferApi(JSONObject parameter, final FBAllRewardOfferCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onAllRewardOfferCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
...
//            // getClient().get(context, SERVER_URL + "mobile/getofferforcustomer" + "/" + customerId + "/" + "0", entity, "application/json", new JsonHttpResponseHandler() {
    ...
    public void getTokenApi(JSONObject parameter, final FBGetTokenCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onGetTokencallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    public void getRefreshToken(JSONObject parameter, final FBGetRefreshTokenCallback callback) {
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onGetRefreshTokencallback(null, FBUtility.getNetworkError());
            } else {
                String url = "wallet/getrefreshtoken?memberId=" + FBPreferences.sharedInstance(fbSdk.context).getUserMemberforAppId();
                FBService.getInstance().get(url, null, getRefreshTokenHeader(), new FBServiceCallback() {

                    @Override
                    public void onServiceCallback(JSONObject response, Exception error, String errorMessage) {
                        if (error == null && response != null) {

                            callback.onGetRefreshTokencallback(response, null);
                        } else {
                            callback.onGetRefreshTokencallback(null, error);
                        }
                    }
    ...
    public void guestUserApi(JSONObject parameter, final FBGuestUserCallback callback) {
        ...
        if(fbSdk!=null) {
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                callback.onGuestUserCallback(null, FBUtility.getNetworkError());
            } else {
                String str = parameter.toString();
    ...
    //Create Member
    HashMap<String, String> getHeaderregistration() {
        HashMap<String, String> header = new HashMap<String, String>();
        header.put("Content-Type", "application/json");
        header.put("Application", "mobilesdk");
        header.put("client_id", FBConstant.client_id);
...
//    }
    ...
    HashMap<String, String> getRefreshTokenHeader() {
        HashMap<String, String> header = new HashMap<String, String>();
        header.put("Content-Type", "application/json");
        header.put("Application", "mobilesdk");
        header.put("client_id", FBConstant.client_id);
    ...
    public interface FBGetRefreshTokenCallback {
