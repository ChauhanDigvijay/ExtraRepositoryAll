	...
	public String getStoreName()
{
	...
	public String getTrigger_Push_Notification()
	{
		String key = "Trigger_Push_Notification";
	...
	public void setTrigger_Push_Notification(String first_time_launch)
	{
		String key = "Trigger_Push_Notification";
		Editor editor = mSharedPreferences.edit();
		editor.putString(key, first_time_launch);
		editor.commit();
	}
