...
public class StoreListMapModelActivity extends Activity implements OnMarkerClickListener, OnMarkerDragListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FBUtils.setUpNavigationDrawerModel(StoreListMapModelActivity.this);
        Intent i = getIntent();
