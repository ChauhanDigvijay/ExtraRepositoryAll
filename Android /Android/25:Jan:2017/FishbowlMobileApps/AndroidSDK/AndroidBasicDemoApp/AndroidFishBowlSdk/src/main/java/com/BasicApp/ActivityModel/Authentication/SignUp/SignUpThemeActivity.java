package com.BasicApp.ActivityModel.Authentication.SignUp;//package com.BasicApp.Activites.NonGeneric.Authentication.SignUp;
//
...
// */
//public class SignUpThemeActivity extends Activity implements View.OnClickListener {
...
////        });
//
//        progressBarHandler = new ProgressBarHandler(SignUpThemeActivity.this);
...
//            @Override
//            public void onClick(View view) {
//                Intent ii = new Intent( SignUpThemeActivity.this, TermsConditionActivity.class);
//                startActivity(ii);
//            }
//        });
...
//            @Override
//            public void onClick(View view) {
//                Intent ii = new Intent( SignUpThemeActivity.this, PrivacyLink.class);
//                startActivity(ii);
//            }
//        });
//
...
//            @Override
//            public void onClick(View view) {
//                Intent ii = new Intent( SignUpThemeActivity.this, SignInActivity.class);
//                startActivity(ii);
//            }
//        });
//
...
//            @Override
//            public void onClick(View view) {
//                SignUpThemeActivity.this.finish();
//            }
//        });
//
//
...
//                creatTextField("FirstName", registerfield.displayName);
//
//            } else if (registerfield.name.equalsIgnoreCase("LastName")) {
//                creatTextField("LastName", registerfield.displayName);
//            } else if (registerfield.name.equalsIgnoreCase("Address")) {
//                creatTextField("Address", registerfield.displayName);
//            } else if (registerfield.name.equalsIgnoreCase("ZipCode")) {
//                creatTextField("ZipCode", registerfield.displayName);
//            } else if (registerfield.name.equalsIgnoreCase("FavoriteStore")) {
//                creatTextField("Favourite Location", registerfield.displayName);
//            } else if (registerfield.name.equalsIgnoreCase("City")) {
//                creatTextField("City", registerfield.displayName);
...
//                creatTextField("EmailAddress", registerfield.displayName);
...
//                creatTextField("State", registerfield.displayName);
//            } else if (registerfield.name.equalsIgnoreCase("PhoneNumber")) {
//                final EditText editText = creatTextField("PhoneNumber", registerfield.displayName);
...
//                creatTextField("Password", registerfield.displayName);
//            }
...
//                {
//                    creatTextField("customeField", registerfield.displayName);
//                }
//
//
//
...
//        LayoutInflater mInflater = (LayoutInflater) SignUpThemeActivity.this.getSystemService(SignUpThemeActivity.this.LAYOUT_INFLATER_SERVICE);
//        view = (LinearLayout) mInflater.inflate(R.layout.signup_button, null, false);
//
//        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
//
//        layoutParams.setMargins(0, FBUtility.inDp(8, SignUpThemeActivity.this), 0, FBUtility.inDp(8, SignUpThemeActivity.this));
...
////                    {
////                       FBUtils.showAlert(SignUpThemeActivity.this(),"sdk");
////                    }
////                    else
////                    {
////
...
//                        FBUtils.showAlert(SignUpThemeActivity.this, "Please provide all digits for birth date");
//                    }
//                }
...
//                DatePickerDialog mDatePicker = new DatePickerDialog(SignUpThemeActivity.this, date, myCalendar
...
//                @Override
//                public void onClick(View view) {
//                    Intent i = new Intent(SignUpThemeActivity.this, SearchStoreActivity.class);
...
////                @Override
////                public void onClick(View v) {
////                    Intent i = new Intent(SignUpThemeActivity.this(), CountryActivity.class);
...
//                public void onClick(View v) {
//
//                    Intent i = new Intent(SignUpThemeActivity.this, StateActivity.class);
...
//                        }
//                    }
//                    object.put("deviceId", FBUtility.getAndroidDeviceID(SignUpThemeActivity.this));
//
...
//                                    FBUtils.showAlert(SignUpThemeActivity.this, "Registration successful! You are now a member of the Sea Island VIP Club. Start earning points every time you dine with us by showing your VIP card or giving you phone number to the cashier.");
//
...
//                                } else {
//                                    progressBarHandler.dismiss();
//                                    FBUtils.tryHandleTokenExpiry(SignUpThemeActivity.this, error);
//                                }
//                            } catch (Exception e) {
//                                e.printStackTrace();
//                            }
...
//                        FBPreferences.sharedInstance(SignUpThemeActivity.this).setAccessTokenforapp(secratekey);
//                        //  FB_LY_UserService.sharedInstance().access_token = response.getString("accessToken");
//                        //   FBPreferences.sharedInstance(SignUpThemeActivity.this()).setSignin(true);
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
//                    getMember();
//                    // progressBarHandler.hide();
//                } else {
//                    FBUtils.tryHandleTokenExpiry((Activity) SignUpThemeActivity.this, error);
//                    progressBarHandler.dismiss();
//                }
//            }
//        });
...
//                        FBPreferences.sharedInstance(SignUpThemeActivity.this).setStoreCode(homeStoreID);
...
//        {
//            FBUtils.showAlert(SignUpThemeActivity.this(),"Invalid Email");
//            return false;
//        }*/
...
//                    FBUtils.showAlert(SignUpThemeActivity.this, "Empty Phone Number");
//                    return false;
//                }
//            }
////        if(!FBUtils.isValidString(Address.getText().toString()))
...
//                if (!FBUtils.isValidString(Password.getText().toString())) {
//                    FBUtils.showAlert(SignUpThemeActivity.this, "Empty Password");
//                    return false;
//                }
//                if (Password.getText().toString().length() < 6) {
//                    FBUtils.showAlert(SignUpThemeActivity.this, "Minimum digit required six.");
//                    return false;
//                }
//            }
//        }
...
//
//        {
//            FBUtils.showAlert(SignUpThemeActivity.this, "Please confirm you have read the Terms Of Use  and Privacy Policy by selecting the appropriate box .");
//            return false;
//        }
//        return true;
//    }
...
//                        if (age >= 21) {
//                            if (age > 100) {
//                                FBUtils.showAlert(SignUpThemeActivity.this, "Maximum age exceeded");
//                                DOB.getText().clear();
//                                return false;
//                            }
//                            return true;
//                        } else {
//                            FBUtils.showAlert(SignUpThemeActivity.this, "Ineligible, Age not over 21");
//                            DOB.getText().clear();
//                            return false;
//                        }
//                    } else
...
//                }
//            } else {
//                FBUtils.showAlert(SignUpThemeActivity.this, "Please enter a valid birth date mm/dd/yyyy");
//                return false;
//            }
//
//        } else
//
//        {
//            FBUtils.showAlert(SignUpThemeActivity.this, "Empty date of birth field");
//            return false;
//
//        }
//        return false;
...
//
//        } else {
//            FBUtils.showAlert(SignUpThemeActivity.this, "Invalide Month");
//        }
//    }
//
//
...
//
//        } else {
//            FBUtils.showAlert(SignUpThemeActivity.this, "Invalide Date");
//        }
//    }
//
//
...
//
//        } else {
//            FBUtils.showAlert(SignUpThemeActivity.this, "Invalide Year");
//        }
//    }
//
////
...
//                        FBPreferences.sharedInstance(SignUpThemeActivity.this).setAccessToken(secratekey);
//
//                        createMember();
//                    } catch (Exception e) {
//                        e.printStackTrace();
...
//
//        RewardPointService.getUserRewardPoint(SignUpThemeActivity.this, new RewardSummaryPointCallback() {
//            @Override
//            public void onRewardSummaryPointCallback(RewardPointSummary rewardSummary, Exception error) {
//                if (rewardSummary != null) {
//                    Intent ii = new Intent(SignUpThemeActivity.this, DashboardActivity.class);
//                    startActivity(ii);
//                    checktermandconditon = false;
//                    progressBarHandler.dismiss();
//                } else {
