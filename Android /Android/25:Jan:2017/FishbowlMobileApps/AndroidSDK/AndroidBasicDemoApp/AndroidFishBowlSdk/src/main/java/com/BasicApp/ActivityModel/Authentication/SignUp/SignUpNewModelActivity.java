package com.BasicApp.ActivityModel.Authentication.SignUp;
...
import com.BasicApp.ActivityModel.Store.SearchStoreModelActivity;
 ...
 */
public class SignUpNewModelActivity extends Activity implements View.OnClickListener {
...
//        });
        ...
        progressBarHandler = new ProgressBarHandler(SignUpNewModelActivity.this);
        ...
        terms_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ii = new Intent(SignUpNewModelActivity.this, TermsConditionActivity.class);
                startActivity(ii);
            }
        });
        ...
        privacy_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ii = new Intent(SignUpNewModelActivity.this, PrivacyLink.class);
                startActivity(ii);
            }
        });
        ...
        signin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ii = new Intent(SignUpNewModelActivity.this, SignInActivity.class);
                startActivity(ii);
            }
        });
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SignUpNewModelActivity.this.finish();
            }
        });
...
//                    {
//                       FBUtils.showAlert(SignUpNewModelActivity.this(),"sdk");
//                    }
//                    else
//                    {
//
...
//                @Override
//                public void onClick(View v) {
//                    Intent i = new Intent(SignUpNewModelActivity.this(), CountryActivity.class);
...
//                public void onClick(View v) {
//
//                    Intent i = new Intent(SignUpNewModelActivity.this, StateModelActivity.class);
...
//                    }
                    ...
                    object.put("deviceId", FBUtility.getAndroidDeviceID(SignUpNewModelActivity.this));
...
//                        if (FBUtils.isValidString(statecode)) {
//
//                            customer.setAddressState(statecode);
//                        }
//                    }
                    if (activeFields.City) {
                        if (FBUtils.isValidString(City.getText().toString())) {
...
//        FBSessionService.currentSession=null;
            ...
            public void onLoginMemberCallback(JSONObject response, Exception error) {
                if (response != null) {
                    try {
                        ...
                        FBPreferences.sharedInstance(SignUpNewModelActivity.this).setAccessTokenforapp(secratekey);
                        //  FB_LY_UserService.sharedInstance().access_token = response.getString("accessToken");
                        //   FBPreferences.sharedInstance(SignUpNewModelActivity.this()).setSignin(true);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    getMember();
                    ...
                    FBUtils.tryHandleTokenExpiry((Activity) SignUpNewModelActivity.this, error);
                    progressBarHandler.dismiss();
                }
            }
        });
            ...
            public void onGetMemberCallback(JSONObject response, Exception error) {
                if (response != null) {
                    ...
                    try {
                        ...
                        FBPreferences.sharedInstance(SignUpNewModelActivity.this).setStoreCode(homeStoreID);
...
//                    FBUtils.showAlert(SignUpNewModelActivity.this, "Empty State");
//                    return false;
//                }
//            }
//
     ...
     /*   if (FBUtils.isValidEmail(email.getText().toString()))
        {
            FBUtils.showAlert(SignUpNewModelActivity.this(),"Invalid Email");
            return false;
        }*/
...
//        }
    ...
    public void CheckDOBforyear(final String date) {
        ...
        if (matcher.matches()) {
            ...
            FBUtils.showAlert(SignUpNewModelActivity.this, "Invalide Year");
        }
    }
...
//                        FBPreferences.sharedInstance(SignUpNewModelActivity.this()).setSignin(true);
    ...
    private void fetchRewardPoint() {
        ...
        RewardPointService.getUserRewardPoint(SignUpNewModelActivity.this, new RewardSummaryPointCallback() {
            @Override
            public void onRewardSummaryPointCallback(RewardPointSummary rewardSummary, Exception error) {
                if (rewardSummary != null) {
                    Intent ii = new Intent(SignUpNewModelActivity.this, DashboardActivity.class);
                    startActivity(ii);
                    checktermandconditon = false;
                    progressBarHandler.dismiss();
                } else {
