...
public class PointBankRedeemedActivity extends Activity {
    String htmlbody;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.findViewById(R.id.backbutton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PointBankRedeemedActivity.this.finish();
            }
        });
        Intent i = getIntent();
        ...
        if (extras != null) {
            ...
            item = (RewardsItem) extras.getSerializable("item");
        }
        ...
        RewardPointService.getUserRewardPoint(this, new RewardSummaryPointCallback() {
            ...
            public void onRewardSummaryPointCallback(RewardPointSummary rewardSummary, Exception error) {
                ...
                if (rewardSummary != null) {
                    ...
                    //  enableScreen(true);
                    FBUtils.tryHandleTokenExpiry(PointBankRedeemedActivity.this, error);
                }
            }
        });
    }
...
*/
    ...
    private void doPhotoPrint(RewardsItem item) {
        PrintHelper photoPrinter = new PrintHelper(PointBankRedeemedActivity.this);
        ...
        View v1 = PointBankRedeemedActivity.this.getWindow().getDecorView().getRootView();
...
//    }
    ...
    public void showalertoffer() {
        AlertDialog alertDialog = new AlertDialog.Builder(PointBankRedeemedActivity.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT).create();
