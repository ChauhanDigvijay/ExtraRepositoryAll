...
import com.BasicApp.Activites.NonGeneric.Authentication.SignIn.ChangePasswordActivity;
...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FavoriteStore != null) {
            ...
            FavoriteStore.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent i = new Intent(UserProfileActivity.this, SearchStoreActivity.class);
        ...
        if (name.equals(member.addressState)) {
            ...
            State.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(UserProfileActivity.this, ActivityState.class);
        ...
        FBUserService.sharedInstance().memberUpdate(object, new FBMemberUpdateCallback() {
            ...
            public void onMemberUpdateCallback(JSONObject response, Exception error) {
                ...
                if (response != null) {
                    ...
                    FBUtils.tryHandleTokenExpiry(UserProfileActivity.this, error);
    ...
    public void logout() {
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(UserProfileActivity.this).create();
                ...
                FBUserService.sharedInstance().logout(object, new FBUserService.FBLogoutCallback() {
                    ...
                    public void onLogoutCallback(JSONObject response, Exception error) {
                        ...
                        if (response != null) {
                            ...
                            FBPreferences.sharedInstance(UserProfileActivity.this).setSignin(false);
                            UserProfileActivity.this.finish();
