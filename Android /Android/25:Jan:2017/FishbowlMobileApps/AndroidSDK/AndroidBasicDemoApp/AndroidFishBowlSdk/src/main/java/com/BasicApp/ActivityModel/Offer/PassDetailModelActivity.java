...
import com.BasicApp.Activites.NonGeneric.Offer.BackPassDetail_Activity;
...
import com.fishbowl.basicmodule.Services.FBUserOfferService.FBOfferPassCallback;
    ...
    public void PkpassReadServices(byte[] offerpass)
    {
        ...
        B1.setOnClickListener(new View.OnClickListener() {
...

            {
                ...
                Intent intent = new Intent(PassDetailModelActivity.this,BackPassDetail_Activity.class);
