 ...
 */
public class FBParseMember {
    public static  String CUSTOMER_ID="memberId";
    public static  String EMAIL="emailAddress";
    public static  String SMS_OPTIN="sMSOptIn";
    public static  String MAIL_OPTIN="emailOptIn";
    ...
    public static  String ZIP="zipCode";
    public static  String BIRTH_DATE="dOB";
    public static  String PASSWORD="password";
    public static  String HOME_STORE_ID="favoriteStore";
    public static  String Loyality_No="loyaltyno";
    /**
     * Created by digvijay(dj)
     */
