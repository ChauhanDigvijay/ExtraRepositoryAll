...
public class FBGiftService {
    ...
    public void getGiftAndroidPayJWT(JSONObject parameter, final FBGetSaveGiftJWTokenCallback callback) {
        if (fbSdk != null) {
            ...
            if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
                ...
                FBService.getInstance().post(url, str, getGiftAndroidPayHeader(), true,new FBServiceCallback() {
    ...
    public void updateGiftAndroidPay(JSONObject parameter, final FBGetSaveGiftJWTokenCallback callback) {
        if(fbSdk!=null) {
        if (!FBUtility.isNetworkAvailable(fbSdk.context)) {
            callback.onFBGetSaveGiftJWTokenCallback(null, FBUtility.getNetworkError());
        } else {
