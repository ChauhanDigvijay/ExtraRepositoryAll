...
public class FBStoresSearchItem implements Serializable{
     ...
     * Created by digvijay(dj)
     */
    public FBStoresSearchItem(){}
    public FBStoresSearchItem(JSONObject obj)
    {
        try
        {

            storeID = obj.has("storeId") ? obj.getInt("storeId") : 0;
          //  companyID = obj.has("description") ? obj.getString("description") : 0;
