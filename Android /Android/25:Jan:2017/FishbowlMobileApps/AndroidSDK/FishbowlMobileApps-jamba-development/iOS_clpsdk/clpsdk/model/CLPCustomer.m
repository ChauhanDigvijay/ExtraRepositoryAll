...
-(id)initWithCoder:(NSCoder *)aDecoder{
    ...
    self.homeStore = [aDecoder decodeObjectForKey:@"homeStore"];
    self.favoriteDepartment = [aDecoder decodeObjectForKey:@"favoriteDepartment"];
...
-(void)encodeWithCoder:(NSCoder *)aCoder{
    ...
    [aCoder encodeInteger:self.customerID forKey:@"customerID"];
    ...
    [aCoder encodeObject:self.homeStore forKey:@"homeStore"];
    [aCoder encodeObject:self.favoriteDepartment forKey:@"favoriteDepartment"];
