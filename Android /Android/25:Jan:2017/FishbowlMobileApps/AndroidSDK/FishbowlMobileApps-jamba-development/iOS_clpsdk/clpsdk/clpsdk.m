...
@synthesize MAX_STORE_COUNT,companyID,isFirstTimeAppLaunch,isStoreListPopulated,beaconRegion,beaconRegions,storeBeacons,beaconRegionsAlreadyFound,startTransientRegion,transientRegion,lastInsideRegionCheck,isTriggerAppEvent,isTriggerBeacon,isTriggerGeoFence,isTriggerErrorEvent,isPushNotification,intMaxEvents,intDelayTimer,isInAPPOffer,appVersion,isForceUpdate,appInformation,intFrequency;
@synthesize delegate,authToken,intTokenCounter;
...
-(void)getMobilePreference{
    ...
    [manager.requestSerializer setValue:authToken forHTTPHeaderField:@"CLP-API-KEY"];
    NSLog(@" Hit getMobilePreference");

    [manager GET:[SERVER_URL stringByAppendingString:@"clpapi/mobilesettings"]
      parameters:nil
         success:^(AFHTTPRequestOperation *operation, id responseObject) {
             
             [instance getALLStoreList];
             ...
             if ([responseObject isKindOfClass:[NSDictionary class]]) {
                 if([[[(NSDictionary*)responseObject valueForKey:@"mobSettingList"] valueForKey:@"mobileSettings"] isKindOfClass:[NSArray class] ]){
                     ...
                     if ([self getObjectForMobileSettingsName:@"VERSION"]!=nil) {
                         appVersion = [self getObjectForMobileSettingsName:@"VERSION"];
                         NSLog(@"appVersion is %@",appVersion);

                     }
                     if ([self getObjectForMobileSettingsName:@"FORCEUPDATE"]!=nil) {
                         isForceUpdate = [[self getObjectForMobileSettingsName:@"FORCEUPDATE"] intValue];
                         NSLog(@"isForceUpdate is %i",isForceUpdate);

                     }
                     if ([self getObjectForMobileSettingsName:@"INFORMATION"]!=nil) {
                         appInformation = [self getObjectForMobileSettingsName:@"INFORMATION"];
                     }
                     
                     if ([self getObjectForMobileSettingsName:@"FREQUENCY"]!=nil) {
                         intFrequency = [[self getObjectForMobileSettingsName:@"FREQUENCY"] intValue];
                     }
                 ...
                 if([[[(NSDictionary*)responseObject valueForKey:@"digitalEventList"] valueForKey:@"digitalEvents"] isKindOfClass:[NSArray class] ]){
                     digitalEventSettings =[[(NSArray*)responseObject valueForKey:@"digitalEventList"]valueForKey:@"digitalEvents"];
                     NSLog(@"digitalEventSettings are %@",digitalEventSettings.description);
                     
                     for (NSDictionary *dict  in digitalEventSettings) {
                         
                         if([dict objectForKey:@"successFlag"]!=nil && [dict objectForKey:@"eventTypeName"]!=nil){
                     ...
                     if(isOpen == NO)
                     {
                         ...
                         NSLog(@"opened event called---%i",isOpen);
                 ...
                 [self.delegate mobileSettingsResponseSucceed];
...
- (void)saveCustomer:(CLPCustomer *)customerInfo :(void (^)(CLPCustomer *cusInfo, NSError *error))response {
    ...
    [manager POST:[SERVER_URL stringByAppendingString:@"clpapi/mobile/appcustomer"] parameters:[customerInfo toDictionary] success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([responseObject isKindOfClass:[NSDictionary class]]) {
            ...
            currentCustomer.customerID=[[customerresponse valueForKey:@"customerID"] intValue];
            if (currentCustomer.customerID == 0)
            {
                currentCustomer.customerID = 7;
            }
            currentCustomer.companyID=[[customerresponse valueForKey:@"companyId"]intValue];
            ...
            currentCustomer.emailID=[customerresponse valueForKey:@"emailID"];
            ...
            currentCustomer.loginPassword=[customerresponse valueForKey:@"loginPassword"];
...
-(void)processPushMessage:(NSDictionary*)userInfo{
    @try{
        ...
        if(url){
            if(!ntype || ([ntype caseInsensitiveCompare:@"pass"]==NSOrderedSame) || ([ntype caseInsensitiveCompare:@""]==NSOrderedSame)){
        ...
        if(alert){
            ...
            [delegate clpPushDataBinding:alert withId:offerid];
        ...
        [clpEvent setValue:[NSNumber numberWithLong:7] forKey:@"companyid"];
        ...
        if(currentCustomer && currentCustomer.customerID && currentCustomer.customerID!=0){
            [clpEvent setValue:[[NSNumber alloc] initWithLong:currentCustomer.customerID] forKey:@"customerid"];
        }else{
...
-(void)updateLocation:(CLPMobileEvent *)event{
    ...
    if(lastlocation_updatetime && abs([lastlocation_updatetime timeIntervalSinceNow])<LOCATION_UPDATE_PING_FREQUENCY){
...
-(void)updateAppEvent:(NSDictionary *)submitAppEvents{
    ...
    @try {
        ...
        if(currentCustomer)
        {
            [mydict setValue:[[NSNumber alloc] initWithLong:currentCustomer.customerID] forKey:@"customerid"];
          
            [mydict setValue:[[NSNumber alloc] initWithLong:7] forKey:@"companyid"];
        }
        ...
        if(currentCustomer && currentCustomer.deviceType){
...
-(void)appEventTimerMethodCall
{
    ...
    if(arrEventRequest.count>0)
    {
        ...
        [manager POST:[SERVER_URL stringByAppendingString:@"clpapi/mobile/submitallappevents"] parameters:dictPost success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
-(void)locationManager:(CLLocationManager *)manager didRangeBeacons:(NSArray *)beacons
    ...
    [httpReqopmgr.requestSerializer setValue:authToken forHTTPHeaderField:@"CLP-API-KEY"];
...
-(void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations{
    ...
    if(isInRegion && isTriggerGeoFence == YES){                                                   //send location update to server only when user in region
        ...
        locationEvent.company=7;
        locationEvent.customerid=currentCustomer.customerID;
...
-(void)getToken:(void (^)(BOOL success, NSError *error))response
{
    ...
    NSMutableDictionary *dictPost = [[NSMutableDictionary alloc]init];
    [dictPost setValue:mobileAPIKey forKey:@"secret"];
    
    [manager POST:[SERVER_URL stringByAppendingString:@"clpapi/mobile/getToken"]
      parameters:dictPost
         success:^(AFHTTPRequestOperation *operation, id responseObject) {
             ...
             if ([responseObject isKindOfClass:[NSDictionary class]]) {
                 ...
                 NSDictionary *storeresponse=(NSDictionary*)responseObject;
                 NSLog(@"Token.description is @%@",storeresponse.description);
                 
                 authToken = [storeresponse objectForKey:@"token"];
