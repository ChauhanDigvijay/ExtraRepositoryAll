...
import com.wearehathway.apps.olo.Interfaces.OloBillingAccountCallback;
import com.wearehathway.apps.olo.Interfaces.OloServiceCallback;
import com.wearehathway.apps.olo.Interfaces.OloUserContactDetailCallback;
import com.wearehathway.apps.olo.Interfaces.OloUserOrderServiceCallback;
import com.wearehathway.apps.olo.Interfaces.OloUserPostServiceCallback;
import com.wearehathway.apps.olo.Interfaces.OloUserServiceCallback;
...
import static com.wearehathway.apps.olo.Utils.Constants.FORGOT_PASSWORD;
...
public class OloUserService
{
    ...
    public static void getBillingAccount(String basketId,final OloBillingAccountCallback callback)
    {
        String authToken = OloSessionService.currentSesstion.getAuthToken();
        if(authToken == null)
        {
        ...
        HashMap<String, Object> parameters = new HashMap<>();
        parameters.put("basket", basketId);
        OloService.getInstance().get(path, parameters, new OloServiceCallback()
        {
            ...
            public void onServiceCallback(JSONObject response, Exception error)
            {
                ...
                if (response != null)
                {
                    ...
                    try
                    {
                        JSONArray jsonArray = response.getJSONArray("billingaccounts");
