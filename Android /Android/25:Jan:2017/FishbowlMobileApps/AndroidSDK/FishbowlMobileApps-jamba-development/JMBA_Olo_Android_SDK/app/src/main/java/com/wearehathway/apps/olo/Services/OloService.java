...
import com.wearehathway.apps.olo.Misc.CustomJsonObjectRequest;
import com.wearehathway.apps.olo.Utils.Constants;
...
public class OloService {
    ...
    public void get(String path, HashMap<String, Object> parameters, String authToekn, OloServiceCallback callback) {
        sendRequest(Request.Method.GET, path, authToekn, parameters, callback);
    }
