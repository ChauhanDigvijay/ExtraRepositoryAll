...
class Store: Equatable, CustomStringConvertible {
    ...
    var id: String? //SpendGo Store Id
    ...
    init(parseObject: PFObject) {
        id           = parseObject["id"] as? String//Should always be present in this case but just in case.
    ...
    func serializeAsParseObject() -> PFObject {
        ...
        parseObject["id"]           = id ?? NSNull()//Should always be present in this case but just in case.
