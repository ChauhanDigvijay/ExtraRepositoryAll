...
class UserProfileTableViewController : UITableViewController, UITextFieldDelegate, PagedImagesViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // User preferred store changed
             NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(UserProfileTableViewController.showUserPreferredStore), name: JambaNotification.PreferredStoreChanged.rawValue, object: nil)
