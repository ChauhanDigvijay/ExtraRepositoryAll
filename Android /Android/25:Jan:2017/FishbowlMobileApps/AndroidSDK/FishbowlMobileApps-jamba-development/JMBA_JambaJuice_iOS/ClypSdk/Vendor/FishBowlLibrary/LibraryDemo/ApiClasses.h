...
-(void)getallrewardofferApi:(NSDictionary *)dictValue url:(NSString *)baseURl withTarget:(id)tempTarget withSelector:(SEL)tempSelector;
...
-(void)getStoreDetails:(NSDictionary *)dictValue url:(NSString *)baseURl withTarget:(id)tempTarget withSelector:(SEL)tempSelector;
...
-(void)getPointBankOffer:(NSDictionary *)dictValue url:(NSString *)baseURl withTarget:(id)tempTarget withSelector:(SEL)tempSelector;
...
-(void)menuFamily:(NSDictionary *)dictValue url:(NSString *)baseURl withTarget:(id)tempTarget withSelector:(SEL)tempSelector;


 #pragma mark -  Get_Category api method
-(void)getCategory:(NSDictionary *)dictValue url:(NSString *)baseURl withTarget:(id)tempTarget withSelector:(SEL)tempSelector;
...
-(void)categorySubCategory:(NSDictionary *)dictValue url:(NSString *)baseURl withTarget:(id)tempTarget withSelector:(SEL)tempSelector;


#pragma mark -  categoryProductList API
-(void)categoryProductList:(NSDictionary *)dictValue url:(NSString *)baseURl withTarget:(id)tempTarget withSelector:(SEL)tempSelector;
