...
public struct OloRestaurant {
    ...
    public var supportsOrderAhead: Bool
    ...
    public init(json: JSON) {
        ...
        supportedCardTypes = json["supportedcardtypes"].stringValue.componentsSeparatedByString("/")
        ...
        supportsOrderAhead = json["supportsonlineordering"].boolValue
