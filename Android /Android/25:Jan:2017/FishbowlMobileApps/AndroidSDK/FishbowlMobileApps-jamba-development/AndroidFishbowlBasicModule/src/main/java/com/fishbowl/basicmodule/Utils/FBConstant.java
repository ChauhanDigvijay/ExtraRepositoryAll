...
public class FBConstant {
	...
	public static String  client_id_for_dev="201969E1BFD242E189FE7B6297B1B5A5";



	//public static String client_id ="201969E1BFD242E189FE7B6297B1B5A3";//hbh_stg
	public static String  client_id= FBConfig.getClient_id();

	//public static String  client_secret="C65A0DC0F28C469FB7376F972DEFBCB7";
	//public static String client_secret ="C65A0DC0F28C469FB7376F972DEFBCB3";//hbh_stg

	public static String  client_secret= FBConfig.getClient_secret();

	//public static String  client_tenantid="581";
