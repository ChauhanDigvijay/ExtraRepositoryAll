...
class InCommOrderRecipientDetailsHelper {
    ...
    class func createOrderRecipientDetailsWithDiffrentiatingNumber(num: Int) -> InCommOrderRecipientDetails {
        //Item
    ...
    class func testOrderRecipientDetails(orderRecipientDetails: InCommOrderRecipientDetails) {
    ...
    class func testOrderRecipientDetailsJSONDict(orderRecipientDetailsJSONDict: InCommJSONDictionary, orderRecipientDetails: InCommOrderRecipientDetails) {
