...
//		try {
//			fbSdk = FBSdk.sharedInstance(this);
...
//				fbSdk.getAllStores();// download storelist if location
//										// sevice
//										// started before
//			} else {
...
//		fbSdk.getBeaconsForStoreNo(stores);
//	}
//
//
//
...
//		//fbSdk.displayLocalPushNotification("GeoFence connected",
