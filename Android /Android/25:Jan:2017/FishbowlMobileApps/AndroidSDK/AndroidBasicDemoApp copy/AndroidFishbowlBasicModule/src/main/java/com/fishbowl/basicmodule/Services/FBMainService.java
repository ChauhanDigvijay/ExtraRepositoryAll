...
public class FBMainService
{
    ...
    private FBSdk fbSdk;
  //  private String apiBaseUrl= "https://qa-jamba.fishbowlcloud.com/clpapi/";
    private String apiBaseUrl= "https://test.fishbowlcloud.com/clpapi/";
    ...
    public void put(String path, HashMap<String, Object> parameters,boolean flag, FBJsonServiceCallback callback)
    {
        sendRequestFlag(Request.Method.PUT, path, parameters, callback);

        //makeRequest(Request.Method.PUT, path, parameters, callback);
    }
    ...
    // Private Methods
    private void sendRequestFlag(int method, String path, HashMap<String, Object> parameters, final FBJsonServiceCallback callback)
    {
        String url = getCompleteServerUrl(path);
        ...
        })
        {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError
            {
                return getServiceHedersFlag(finalUrl, new String(getBody()));
            }
    ...
    private Map<String, String> getServiceHedersFlag(String finalUrl, String body)
    {
        Map<String, String> headers = new HashMap<String, String>();
        headers.put("Content-Type", "application/json");
        headers.put("Application", "mobilesdk");
