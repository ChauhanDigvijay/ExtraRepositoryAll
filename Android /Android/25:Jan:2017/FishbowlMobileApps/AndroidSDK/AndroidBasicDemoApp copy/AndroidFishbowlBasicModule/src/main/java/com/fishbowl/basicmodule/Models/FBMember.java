...
public class FBMember {
    ...
    private Boolean requestFromJoinPage;
    ...
    public Boolean getRequestFromJoinPage() {
        return requestFromJoinPage;
    }

    public void setRequestFromJoinPage(Boolean requestFromJoinPage) {
        this.requestFromJoinPage = requestFromJoinPage;
    }
