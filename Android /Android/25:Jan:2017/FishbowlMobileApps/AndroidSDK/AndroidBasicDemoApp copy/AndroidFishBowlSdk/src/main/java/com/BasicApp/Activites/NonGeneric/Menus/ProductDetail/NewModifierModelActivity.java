...
// */
//
//public class NewModifierModelActivity extends ActionBarActivity implements View.OnClickListener{
...
//                Intent intent = new Intent(NewModifierModelActivity.this, OrderConfirmActivity.class);
...
//
//                Intent menucart = new Intent(NewModifierModelActivity.this, OrderConfirmActivity.class);
...
//                Bundle extras = new Bundle();
//                Intent inten = new Intent(NewModifierModelActivity.this, MenuActivity.class);
//                inten.putExtras(extras);
//                inten.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                startActivity(inten);
//                NewModifierModelActivity.this.finish();
//            }
//        });
...
//        FBUtils.setUpNavigationDrawerModel(NewModifierModelActivity.this);
...
//        FBUserService.sharedInstance().getMenuProduct(object, FBPreferences.sharedInstance(NewModifierModelActivity.this).getStoreCode(), String.valueOf(categoryID), String.valueOf(subCategoryID), String.valueOf(productID), new FBUserService.FBMenuProductCallback() {
//
...
//
//        AlertDialog alertDialog = new AlertDialog.Builder(NewModifierModelActivity.this).create();
