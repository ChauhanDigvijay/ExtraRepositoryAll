...
public class PointBankAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int newPosition;
        Gson gson = new Gson();
        String json = FBPreferences.sharedInstance(context).mSharedPreferences.getString("FBUser", "");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    object.put("memberId",FBPreferences.sharedInstance(context).getUserMemberforAppId());
