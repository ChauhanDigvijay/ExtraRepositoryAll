...
// */
//
//public class NewBasicMainActivity extends Activity implements View.OnClickListener, FBSdk.OnFBSdkRegisterListener {
...
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "MobileSettingsService Success Message" + state);
//
//                    // EventCheckGuest();
//                    getViewMobileSettingsServiceSettings();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "MobileSettingsService Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
//    }
...
//
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "MobileSettingsService Success Message" + response);
//
//
//                    loginMember("978-872-3059", "123456");
//
//                } else {
//
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "MobileSettingsService Error Message");
...
//
//                {
//                   Constants.alertDialogShow(NewBasicMainActivity.this, "loginMember Success Message" + spendGoSession);
//                    String secratekey = spendGoSession.getAccessToken();
//                    FBPreferences.sharedInstance(NewBasicMainActivity.this).setAccessTokenforapp(secratekey);
////                    FBUserService.sharedInstance().access_token = spendGoSession.getAccessToken();
////                    FBPreferences.sharedInstance(NewBasicMainActivity.this).setSignin(true);
//                   // createUser(collectCustomerData());
//                    //getAllStores();
//                  //  getMenuCategory();
//
//                    GetMember();
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "loginMember Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//
//        FBSessionService.getTokenApi(user, new FBSessionServiceCallback() {
//            @Override
//            public void onSessionServiceCallback(final FBSessionItem spendGoSession, Exception error) {
//                if (error != null)
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "createUser Success Message" + spendGoSession);
//                    UpdateMember(collectCustomerData());
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "createUser Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//
//                }
//            }
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "memberUpdate Success Message" + spendGoSession);
//                    GetMember();
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "memberUpdate Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//
//                }
//            }
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "GetMember Success Message" + user);
...
//                    UpdateDevice();
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "GetMember Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//
//                }
//            }
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "UpdateDevice Success Message" + spendGoSession);
//                    getAllStores();
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "UpdateDevice Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//
//                }
//            }
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getAllStores Success Message" + response);
//                    getStoresDetail();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getAllStores Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//                if (response != null) {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getStoresDetail Success Message" + response);
//                    getStoresSearch();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getStoresDetail Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//            public void onRestaurantServiceCallback(FBRestaurantListItem response, Exception error) {
//                if (response != null) {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getStoresSearch Success Message" + response);
//                    favouriteStoreUpdate();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getStoresSearch Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "favouriteStoreUpdate Success Message" + response);
//                    getMenuCategory();
//                  //  getBonusRuleList();
//                  //  getUserLogout("mobilesdk");
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "favouriteStoreUpdate Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getMenuCategory Success Message" + response);
//                    getSubMenuCategory();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getMenuCategory Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getSubMenuCategory Success Message" + response);
//                    getMenuDrawerListProduct();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getSubMenuCategory Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getMenuDrawerListProduct Success Message" + response);
//                    getMenuProductDetail();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getMenuDrawerListProduct Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getMenuProductDetail Success Message" + category);
//                    getUserOffers();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getMenuProductDetail Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getUserOffers Success Message" + response);
//                    getUserReward();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getUserOffers Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getUserOffers Success Message" +restaurants);
//                    useOffer("328829","13");
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getUserOffers Error Message");
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "useOffer Success Message" + restaurants);
//                    getBonusRuleList();
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "useOffer Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                    getBonusRuleList();
//                }
//            }
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getBonusRuleList Success Message" + restaurants);
//                    getUserLogout("mobilesdk");
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getBonusRuleList Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                    getUserLogout("mobilesdk");
//                }
//            }
...
//
//                {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getUserLogout Success Message" + spendGoSession);
//
//                } else {
//                    Constants.alertDialogShow(NewBasicMainActivity.this, "getUserLogout Error Message");
//                    FBUtils.tryHandleTokenExpiry(NewBasicMainActivity.this, error);
//                }
//            }
//        });
