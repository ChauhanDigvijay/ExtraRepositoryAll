...
public class FragmentLoyaltyCard extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String buttoncolor = FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralButtonBGColorNormal");
        if (buttoncolor != null) {
            String btncolor = buttoncolor;
            sendEmail.setBackgroundColor(Color.parseColor(btncolor));
            print.setBackgroundColor(Color.parseColor(btncolor));
        }
                            ...
                            if (model != null) {
                                ...
                                if (StringUtilities.isValidString(model.barcodeType)) {
                                    if (model.barcodeType.equalsIgnoreCase("BAR")) {
                                        url5 = "https://promotionsmanager.fishbowl.com/PromotionsManager/Handlers/BarCodeGen.ashx?valueToEncode=" + FB_LY_UserService.sharedInstance().member.loyalityNo + "&BarCodeType=Code128&dpi=105&showText=false";
                                        ...
                                        url5 = "https://promotionsmanager.fishbowl.com/PromotionsManager/Handlers/BarCodeGen.ashx?valueToEncode=" + FB_LY_UserService.sharedInstance().member.loyalityNo + "&BarCodeType=QRCode&dpi=105&showText=false";
                                        webView.setWebViewClient(new WebViewClient() {
                                            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                                                view.loadUrl(url5);
                                                return true;
...
//
                                ...
                                if (StringUtilities.isValidString(model.frontHeaderFontSize)) {
                                    if (model.frontHeaderFontSize.contains("px")) {

                                        String[] parts = model.frontHeaderFontSize.split("px");
                                        String part1 = parts[0];
                                        loyaltytitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, Float.parseFloat(part1));
                                    } else {
                                        loyaltytitle.setTextSize(TypedValue.COMPLEX_UNIT_SP, Float.parseFloat(model.frontHeaderFontSize));
                                    }
                                }

                                if (StringUtilities.isValidString(model.frontHeaderFontAlignment)) {
                                    RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)loyaltytitle.getLayoutParams();

                                    if (model.frontHeaderFontAlignment.equalsIgnoreCase("right"))
                                    {

                                        params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
                                        //   params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);

                                        loyaltytitle.setLayoutParams(params);
                                    }
                                    else if (model.frontHeaderFontAlignment.equalsIgnoreCase("left"))
                                    {
                                    ...
                                    else if (model.frontHeaderFontAlignment.equalsIgnoreCase("center"))
                                    {
...
//username
                                ...
                                if (StringUtilities.isValidString(model.frontBodyText1TxtAlign)) {
                                    RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)userName.getLayoutParams();

                                    if (model.frontBodyText1TxtAlign.equalsIgnoreCase("right"))
                                    {
                                    ...
                                    else if (model.frontBodyText1TxtAlign.equalsIgnoreCase("left"))
                                    {
                                        // params.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
                                        params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);
                                    ...
                                    else if (model.frontBodyText1TxtAlign.equalsIgnoreCase("center"))
                                    {
                                        params.addRule(RelativeLayout.CENTER_HORIZONTAL);
                                        // params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);
...
//
                                ...
                                if (StringUtilities.isValidString(model.frontBodyText2TxtAlign)) {
                                    RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)labelmember.getLayoutParams();
                                    RelativeLayout.LayoutParams paramss = (RelativeLayout.LayoutParams)datecreated.getLayoutParams();

                                    if (model.frontBodyText2TxtAlign.equalsIgnoreCase("right"))
                                    {
                                        ...
                                        labelmember.setLayoutParams(params);
                                        datecreated.setLayoutParams(paramss);
                                    }
                                    else if (model.frontBodyText2TxtAlign.equalsIgnoreCase("left"))
                                    {
                                        // params.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
                                        params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);
                                        paramss.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);

                                        labelmember.setLayoutParams(params);
                                        datecreated.setLayoutParams(paramss);
                                    }

                                    else if (model.frontBodyText2TxtAlign.equalsIgnoreCase("center"))
                                    {
                                        params.addRule(RelativeLayout.CENTER_HORIZONTAL);
                                ...
                                if (StringUtilities.isValidString(model.frontBodyText3TxtAlign)) {
                                    RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)labelnumber.getLayoutParams();

                                    if (model.frontBodyText3TxtAlign.equalsIgnoreCase("right"))
                                    {

                                        params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
                                        //   params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);

                                        labelnumber.setLayoutParams(params);
                                    }
                                    else if (model.frontBodyText3TxtAlign.equalsIgnoreCase("left"))
                                    {
                                        // params.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
                                        params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);
                                    ...
                                    else if (model.frontBodyText3TxtAlign.equalsIgnoreCase("center"))
                                    {
                                        params.addRule(RelativeLayout.CENTER_HORIZONTAL);
                                        // params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);
                                ...
                                if (StringUtilities.isValidString(model.frontBodyText4TxtAlign)) {
                                    RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)loyaltyNumber.getLayoutParams();

                                    if (model.frontBodyText4TxtAlign.equalsIgnoreCase("right"))
                                    {

                                        params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
                                        //   params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);

                                        loyaltyNumber.setLayoutParams(params);
                                    }
                                    else if (model.frontBodyText4TxtAlign.equalsIgnoreCase("left"))
                                    {
                                        // params.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
                                        params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);
                                    ...
                                    else if (model.frontBodyText4TxtAlign.equalsIgnoreCase("center"))
                                    {
                                        params.addRule(RelativeLayout.CENTER_HORIZONTAL);
                                     //   params.addRule(RelativeLayout.BELOW, R.id.labelnumber);
                                        // params.addRule(RelativeLayout.RIGHT_OF, R.id.companyLogo);
                                ...
                                if (StringUtilities.isValidString(model.dividerColor)) {
                                    divider_line.setBackgroundColor(Color.parseColor(model.dividerColor));
                                    //   divider_line.setMinimumHeight(5);


                                }


                                if (StringUtilities.isValidString(model.dividerThickness)) {
                                    if (model.dividerThickness.contains("px")) {
                                        String[] parts = model.dividerThickness.split("px");
                                        String part1 = parts[0];
                                        ViewGroup.LayoutParams paramsss = divider_line.getLayoutParams();
                                        paramsss.height = Integer.parseInt(part1);
                                        divider_line.requestLayout();

                                    } else {

                                        ViewGroup.LayoutParams paramss = divider_line.getLayoutParams();
                                        paramss.height = Integer.parseInt(model.dividerThickness);
                                        divider_line.requestLayout();
                                    }
                                }
