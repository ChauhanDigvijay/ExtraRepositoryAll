...
public class MenuActivity extends Activity  implements View.OnClickListener{
    ...
    private NetworkImageView titleimage,img_Back,img_Background;
    ...
    public void   getloyaltyactivity()
  {
    ...
    public void inititateui()
    {
        ...
        if(StringUtilities.isValidString(generalLogoImageUrl))
        {
            ...
            mImageLoader.get(loginleftbgurl, ImageLoader.getImageListener(img_Back, R.color.white, R.color.white));
            img_Back.setImageUrl(loginleftbgurl, mImageLoader);
        }
        else if(FBThemeMobileSettingsService.sharedInstance().generalmapsetting.get("GeneralHeaderColor")!=null)
        {
            ...
            if(StringUtilities.isValidString(generalHeaderColor))
                img_Back.setBackgroundColor(Color.parseColor(generalHeaderColor));
        }
