...
//                detail.setText("No special instructions");
//            } else {
//                detail.setText(recentOrderDetails.getSpecialInstructions());
//            }
...
//                        }
            ...
            if (modifiers.equals("")) {
                if (recentOrderDetails.getSpecialInstructions().isEmpty()) {
                    items.setText("No special instructions");
                    items.setVisibility(View.GONE);
                } else {
                    items.setText(recentOrderDetails.getSpecialInstructions());
                }
            } else {
                ...
                public void onGlobalLayout() {
                    if (seeLess.getVisibility() == View.GONE) {
                        if (items.getLineCount() > 2) {
                            ...
                            items.setEllipsize(TextUtils.TruncateAt.END);

                        }
                    } else {
                        items.setMaxLines(items.getLineCount());
                        items.setEllipsize(null);
                    }
                }
            });
        }
