...
public class FBBeaconService {
	...
	public List<FBBeaconItem> beaconListInGeofence = new ArrayList<FBBeaconItem>(); //old firstname allBeaconsForStores
	...
	public void beaconInRange(FBMobileEventItem mobileEvents, FBBeaconsInRangeCallback callback) {
                        ...
                        try {
							if (response.getBoolean("successFlag")) {
							    ...
							    for (int i = 0; i < getArrayBeacons.length(); i++) {
							        ...
							        FBBeaconItem getBeaconsObj = new FBBeaconItem(myBeaconsObj);
    ...
    public void Start_Beacon_Ranging(final List<FBBeaconItem> lstBeaconRegions){
		...
		beaconManager.connect(new BeaconManager.ServiceReadyCallback() {
			...
			public void onServiceReady() {
				try {
					...
					for (FBBeaconItem beacon : lstBeaconRegions) {
	...
	/////////////////////////////////////////////////////////////////////
	 public void Start_Beacon_Monitoring(final List<FBBeaconItem>ListBeaconRegions) {
	 ...
	 beaconManager.connect(new BeaconManager.ServiceReadyCallback() {
		 ...
		 public void onServiceReady() {
			 try {
				 ...
				 for (FBBeaconItem beacon : ListBeaconRegions) {
