...
extension String {
    ...
    public func prettyFormattedPhoneNumber() -> String {
        ...
        let areaCode = cleanNumber.substring(with: (cleanNumber.startIndex ..< cleanNumber.characters.index(cleanNumber.startIndex, offsetBy: 3)))
        let middleComponent = cleanNumber.substring(with: (cleanNumber.characters.index(cleanNumber.startIndex, offsetBy: 3) ..< cleanNumber.characters.index(cleanNumber.startIndex, offsetBy: 6)))
        let lastComponent = cleanNumber.substring(with: (cleanNumber.characters.index(cleanNumber.startIndex, offsetBy: 6) ..< cleanNumber.endIndex))
