...
public class CLPCustomer implements Serializable{
    ...
    public CLPCustomer(){}
    public CLPCustomer(int customerID, int companyId, String firstName,
            ...
            String customerAge, String homeStore, String favoriteDepartment,
            ...
            String deviceVendor, String modifiedDate, String enabledFlag,String locationEnabled) {
