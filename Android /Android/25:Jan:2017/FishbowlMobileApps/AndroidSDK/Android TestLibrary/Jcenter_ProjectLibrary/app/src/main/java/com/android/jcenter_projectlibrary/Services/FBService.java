...
import com.android.jcenter_projectlibrary.Interfaces.FBStringServiceCallback;
import com.android.jcenter_projectlibrary.Miscellaneous.FBCustomJsonObjectRequest;
import com.android.jcenter_projectlibrary.Utils.FBConstant;
import com.android.jcenter_projectlibrary.Utils.FBPreferences;
import com.android.jcenter_projectlibrary.Utils.FBSessionConstants;
import com.android.jcenter_projectlibrary.Utils.FBUtility;
import com.android.jcenter_projectlibrary.Utils.FBUtils;
import com.android.jcenter_projectlibrary.Utils.Logger;
...
public class FBService
{
    ...
    private FBSdk fbSdk;
    private String apiBaseUrl= fbSdk.SERVER_URL;

    private static FBService instance;

    public static FBService sharedInstance(){
        if(instance==null){
    ...
    private Map<String, String> getServiceHeders(String finalUrl, String body)
    {
        ...
        {
            headers.put("access_token", FBPreferences.sharedInstance(fbSdk.context).getAccessToken());
        }
        return headers;
    }
